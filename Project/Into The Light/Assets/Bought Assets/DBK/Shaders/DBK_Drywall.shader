	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord406 = packedInput.ase_texcoord5.xy * _ColorsNumber + temp_output_404_0;
				...
				float2 texCoord410 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult405;
				...
				float HeightMask10 = saturate(pow(((( 1.0 - tex2DNode351.g )*( ( ( tex2DNode351.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode351.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmoothness));
				...
				float2 texCoord409 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult408;
				...
				float3 temp_cast_9 = (( 1.0 - packedInput.ase_color.r )).xxx;
				...
				float VertexAlpha394 = packedInput.ase_color.a;
				float4 Albedo103 = ( lerpResult30 + ( _InsideBrightness * VertexAlpha394 ) );
				
				float2 uv4_DrywallNM = packedInput.ase_texcoord5.zw * _DrywallNM_ST.xy + _DrywallNM_ST.zw;
				...
				float2 uv4_DrywallDamageNM = packedInput.ase_texcoord5.zw * _DrywallDamageNM_ST.xy + _DrywallDamageNM_ST.zw;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				#endif
				float2 temp_output_404_0 = ( half2( 0.015625,0 ) * staticSwitch415 );
				float2 texCoord406 = packedInput.ase_texcoord2.xy * _ColorsNumber + temp_output_404_0;
				float4 PaintColorUV3389 = tex2D( _ColorTheme, texCoord406 );
				float2 uv4_MainTex = packedInput.ase_texcoord2.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode356 = tex2D( _MainTex, uv4_MainTex );
				float temp_output_38_0 = pow( tex2DNode356.r , _EdgesMultiply );
				float2 appendResult405 = (float2(temp_output_404_0.x , 0.5));
				float2 texCoord410 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult405;
				float4 PaperColorUV3388 = tex2D( _ColorTheme, texCoord410 );
				...
				float3 temp_output_327_0 = ( BricksStep234 * ( ( 1.0 - step( 0.1 , ( 1.0 - saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _ExtraTransitionRange ) / max( 1.0 , 1E-05 ) ) ) ) ) ) ) + clampResult346 ) );
				float2 appendResult408 = (float2(temp_output_404_0.x , 0.1));
				float2 texCoord409 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult408;
				float4 DirtColorUV3390 = tex2D( _ColorTheme, texCoord409 );
				float MasksBlueChannel357 = tex2DNode356.b;
				float3 temp_cast_8 = (( tex2DNode351.b * _DirtMultiplier )).xxx;
				float3 temp_cast_9 = (( 1.0 - packedInput.ase_color.r )).xxx;
				...
				float2 uv4_DrywallNM = packedInput.ase_texcoord2.zw * _DrywallNM_ST.xy + _DrywallNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _DrywallNM, uv4_DrywallNM ), _DrywallNmScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_DrywallNmScale) );
				float2 uv4_DrywallDamageNM = packedInput.ase_texcoord2.zw * _DrywallDamageNM_ST.xy + _DrywallDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _DrywallDamageNM, uv4_DrywallDamageNM ), _DamageNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_DamageNMScale) );
				float3 EdgesDamages199 = temp_output_327_0;
				float3 lerpResult21 = lerp( unpack19 , unpack20 , EdgesDamages199);
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv4_DrywallNM = packedInput.ase_texcoord3.xy * _DrywallNM_ST.xy + _DrywallNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _DrywallNM, uv4_DrywallNM ), _DrywallNmScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_DrywallNmScale) );
				float2 uv4_DrywallDamageNM = packedInput.ase_texcoord3.xy * _DrywallDamageNM_ST.xy + _DrywallDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _DrywallDamageNM, uv4_DrywallDamageNM ), _DamageNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_DamageNMScale) );
				float2 uv4_RGBAMaskA = packedInput.ase_texcoord3.xy * _RGBAMaskA_ST.xy + _RGBAMaskA_ST.zw;
				float4 tex2DNode351 = tex2D( _RGBAMaskA, uv4_RGBAMaskA );
				float HeightMask10 = saturate(pow(((( 1.0 - tex2DNode351.g )*( ( ( tex2DNode351.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode351.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmoothness));
				float Heightmap11 = HeightMask10;
				float temp_output_311_0 = step( 0.1 , Heightmap11 );
				...
				float GreenChannelRGBA123 = tex2DNode351.b;
				float3 temp_cast_3 = (( tex2DNode351.b * _DirtMultiplier )).xxx;
				float3 temp_cast_4 = (( 1.0 - packedInput.ase_color.r )).xxx;
				float DirtHeight74 = saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
				float Smoothness117 = ( ( _SmoothnessMain * RedChannelRGBA109 * ( 1.0 - GreenChannelRGBA123 ) ) * ( 1.0 - ( _SmoothnessDamage * Heightmap11 ) ) * ( 1.0 - ( _SmoothnessDirt * DirtHeight74 ) ) );
		...
		Pass
		{
						...
						)
			{
				...
				#endif
				float2 temp_output_404_0 = ( half2( 0.015625,0 ) * staticSwitch415 );
				float2 texCoord406 = packedInput.ase_texcoord7.xy * _ColorsNumber + temp_output_404_0;
				float4 PaintColorUV3389 = tex2D( _ColorTheme, texCoord406 );
				float2 uv4_MainTex = packedInput.ase_texcoord7.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode356 = tex2D( _MainTex, uv4_MainTex );
				float temp_output_38_0 = pow( tex2DNode356.r , _EdgesMultiply );
				float2 appendResult405 = (float2(temp_output_404_0.x , 0.5));
				float2 texCoord410 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult405;
				float4 PaperColorUV3388 = tex2D( _ColorTheme, texCoord410 );
				...
				float3 temp_output_327_0 = ( BricksStep234 * ( ( 1.0 - step( 0.1 , ( 1.0 - saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _ExtraTransitionRange ) / max( 1.0 , 1E-05 ) ) ) ) ) ) ) + clampResult346 ) );
				float2 appendResult408 = (float2(temp_output_404_0.x , 0.1));
				float2 texCoord409 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult408;
				float4 DirtColorUV3390 = tex2D( _ColorTheme, texCoord409 );
				float MasksBlueChannel357 = tex2DNode356.b;
				float3 temp_cast_8 = (( tex2DNode351.b * _DirtMultiplier )).xxx;
				float3 temp_cast_9 = (( 1.0 - packedInput.ase_color.r )).xxx;
				...
				float2 uv4_DrywallNM = packedInput.ase_texcoord7.zw * _DrywallNM_ST.xy + _DrywallNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _DrywallNM, uv4_DrywallNM ), _DrywallNmScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_DrywallNmScale) );
				float2 uv4_DrywallDamageNM = packedInput.ase_texcoord7.zw * _DrywallDamageNM_ST.xy + _DrywallDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _DrywallDamageNM, uv4_DrywallDamageNM ), _DamageNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_DamageNMScale) );
				float3 EdgesDamages199 = temp_output_327_0;
				float3 lerpResult21 = lerp( unpack19 , unpack20 , EdgesDamages199);
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-2282.435;-299.0128;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;432;3284.435,886.0128;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;431;3160.435,578.0128;Inherit;False;Property;_Color;Color;30;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;418;0;432;0
WireConnection;418;1;93;0
WireConnection;418;7;118;0
WireConnection;418;9;349;0
WireConnection;418;10;429;0
ASEEND*/
//CHKSM=59DA5B4E0C7C35E6E42EEC0282AF7DF81A7A67A6