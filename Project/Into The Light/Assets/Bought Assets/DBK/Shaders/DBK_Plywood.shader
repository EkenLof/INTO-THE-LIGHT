	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord278 = packedInput.ase_texcoord5.xy * _ColorsNumber + temp_output_274_0;
				float4 Color1UV3259 = tex2D( _ColorTheme, texCoord278 );
				float2 uv4_MainTex = packedInput.ase_texcoord5.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode229 = tex2D( _MainTex, uv4_MainTex );
				float2 appendResult275 = (float2(temp_output_274_0.x , 0.5));
				float2 texCoord277 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult275;
				float4 Color2UV3258 = tex2D( _ColorTheme, texCoord277 );
				float2 uv4_RGBAMaskB = packedInput.ase_texcoord5.zw * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode1 = tex2D( _RGBAMaskB, uv4_RGBAMaskB );
				float HeightMask10 = saturate(pow(((( 1.0 - tex2DNode1.a )*( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				...
				float2 texCoord285 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult284;
				...
				float3 temp_cast_6 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode1.r ) )).xxx;
				...
				float4 lerpResult30 = lerp( ( lerpResult14 + ( packedInput.ase_color.a * _BrightAreas * lerpResult14 ) + ( float4( CutoutEdges182 , 0.0 ) * _EdgesBrightness * lerpResult14 ) ) , ( DirtColorUV3260 * HeightMaskBlue232 ) , clampResult270);
				float VertexAlpha265 = packedInput.ase_color.a;
				float4 Albedo103 = ( lerpResult30 + ( VertexAlpha265 * _InsideBrightness ) );
				
				float2 uv4_PlywoodNM = packedInput.ase_texcoord5.zw * _PlywoodNM_ST.xy + _PlywoodNM_ST.zw;
				...
				float2 uv4_PlywoodDamageNM = packedInput.ase_texcoord5.zw * _PlywoodDamageNM_ST.xy + _PlywoodDamageNM_ST.zw;
				...
				surfaceDescription.Smoothness = Smoothness117.x;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half2 _ColorsNumber = half2(0,-0.1);
				float2 temp_output_274_0 = ( half2( 0.015625,0 ) * _ColorSelect );
				float2 texCoord278 = packedInput.ase_texcoord2.xy * _ColorsNumber + temp_output_274_0;
				float4 Color1UV3259 = tex2D( _ColorTheme, texCoord278 );
				float2 uv4_MainTex = packedInput.ase_texcoord2.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode229 = tex2D( _MainTex, uv4_MainTex );
				float2 appendResult275 = (float2(temp_output_274_0.x , 0.5));
				float2 texCoord277 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult275;
				float4 Color2UV3258 = tex2D( _ColorTheme, texCoord277 );
				float2 uv4_RGBAMaskB = packedInput.ase_texcoord2.zw * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode1 = tex2D( _RGBAMaskB, uv4_RGBAMaskB );
				float HeightMask10 = saturate(pow(((( 1.0 - tex2DNode1.a )*( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				...
				float4 lerpResult14 = lerp( ( Color1UV3259 * pow( tex2DNode229.r , _DirtOverlay ) ) , ( Color2UV3258 * pow( tex2DNode229.b , _SplintersOverlay ) ) , float4( clampResult221 , 0.0 ));
				float2 appendResult284 = (float2(temp_output_274_0.x , 0.1));
				float2 texCoord285 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult284;
				float4 DirtColorUV3260 = tex2D( _ColorTheme, texCoord285 );
				float HeightMaskBlue232 = tex2DNode1.b;
				float3 temp_cast_5 = (( tex2DNode1.g * _DirtMultiplier )).xxx;
				float3 temp_cast_6 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode1.r ) )).xxx;
				...
				float2 uv4_PlywoodNM = packedInput.ase_texcoord2.zw * _PlywoodNM_ST.xy + _PlywoodNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _PlywoodNM, uv4_PlywoodNM ), _PlywoodNMScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_PlywoodNMScale) );
				float2 uv4_PlywoodDamageNM = packedInput.ase_texcoord2.zw * _PlywoodDamageNM_ST.xy + _PlywoodDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _PlywoodDamageNM, uv4_PlywoodDamageNM ), _PlywoodDamgeNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_PlywoodDamgeNMScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , Heightmap11);
				float3 Normals92 = lerpResult21;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv4_PlywoodNM = packedInput.ase_texcoord3.xy * _PlywoodNM_ST.xy + _PlywoodNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _PlywoodNM, uv4_PlywoodNM ), _PlywoodNMScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_PlywoodNMScale) );
				float2 uv4_PlywoodDamageNM = packedInput.ase_texcoord3.xy * _PlywoodDamageNM_ST.xy + _PlywoodDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _PlywoodDamageNM, uv4_PlywoodDamageNM ), _PlywoodDamgeNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_PlywoodDamgeNMScale) );
				float2 uv4_RGBAMaskB = packedInput.ase_texcoord3.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode1 = tex2D( _RGBAMaskB, uv4_RGBAMaskB );
				float HeightMask10 = saturate(pow(((( 1.0 - tex2DNode1.a )*( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				float2 uv_MainTex = packedInput.ase_texcoord3.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode236 = tex2D( _MainTex, uv_MainTex );
				...
				float RedChannelRGBA109 = tex2DNode1.r;
				float GreenChannelRGBA123 = tex2DNode1.g;
				float2 uv4_MainTex = packedInput.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode229 = tex2D( _MainTex, uv4_MainTex );
				float Splinters119 = tex2DNode229.b;
				float3 temp_cast_1 = (( tex2DNode1.g * _DirtMultiplier )).xxx;
				float3 temp_cast_2 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode1.r ) )).xxx;
				float DirtHeight74 = saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
				float3 Smoothness117 = ( ( _SmoothnessWood * RedChannelRGBA109 * ( 1.0 - GreenChannelRGBA123 ) ) * ( 1.0 - ( _SmoothnessDamage * ( 1.0 - Splinters119 ) * Heightmap11 ) ) * ( 1.0 - ( _SmoothnessDirt * DirtHeight74 ) ) );
		...
		Pass
		{
						...
						)
			{
				...
				half2 _ColorsNumber = half2(0,-0.1);
				float2 temp_output_274_0 = ( half2( 0.015625,0 ) * _ColorSelect );
				float2 texCoord278 = packedInput.ase_texcoord7.xy * _ColorsNumber + temp_output_274_0;
				float4 Color1UV3259 = tex2D( _ColorTheme, texCoord278 );
				float2 uv4_MainTex = packedInput.ase_texcoord7.zw * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode229 = tex2D( _MainTex, uv4_MainTex );
				float2 appendResult275 = (float2(temp_output_274_0.x , 0.5));
				float2 texCoord277 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult275;
				float4 Color2UV3258 = tex2D( _ColorTheme, texCoord277 );
				float2 uv4_RGBAMaskB = packedInput.ase_texcoord7.zw * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode1 = tex2D( _RGBAMaskB, uv4_RGBAMaskB );
				float HeightMask10 = saturate(pow(((( 1.0 - tex2DNode1.a )*( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode1.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				...
				float4 lerpResult14 = lerp( ( Color1UV3259 * pow( tex2DNode229.r , _DirtOverlay ) ) , ( Color2UV3258 * pow( tex2DNode229.b , _SplintersOverlay ) ) , float4( clampResult221 , 0.0 ));
				float2 appendResult284 = (float2(temp_output_274_0.x , 0.1));
				float2 texCoord285 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult284;
				float4 DirtColorUV3260 = tex2D( _ColorTheme, texCoord285 );
				float HeightMaskBlue232 = tex2DNode1.b;
				float3 temp_cast_5 = (( tex2DNode1.g * _DirtMultiplier )).xxx;
				float3 temp_cast_6 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode1.r ) )).xxx;
				...
				float2 uv4_PlywoodNM = packedInput.ase_texcoord7.zw * _PlywoodNM_ST.xy + _PlywoodNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _PlywoodNM, uv4_PlywoodNM ), _PlywoodNMScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_PlywoodNMScale) );
				float2 uv4_PlywoodDamageNM = packedInput.ase_texcoord7.zw * _PlywoodDamageNM_ST.xy + _PlywoodDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _PlywoodDamageNM, uv4_PlywoodDamageNM ), _PlywoodDamgeNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_PlywoodDamgeNMScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , Heightmap11);
				float3 Normals92 = lerpResult21;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1016.483;-452.6163;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;301;1909.466,944.2103;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;272;725.8193,-2516.291;Inherit;False;Property;_ColorSelect;ColorSelect;0;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.ColorNode;300;1763.466,688.2103;Inherit;False;Property;_Color;Color;26;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;287;1;93;0
WireConnection;287;7;118;0
WireConnection;287;9;226;0
WireConnection;287;10;298;0
ASEEND*/
//CHKSM=29DF90EB90992D6BBF66BCBC531F9058541487CE