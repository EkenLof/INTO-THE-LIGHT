	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord301 = packedInput.ase_texcoord5.xy * _ColorsNumber + temp_output_298_0;
				...
				float2 texCoord282 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + appendResult283;
				...
				float2 uv3_RGBA_Mask_B = packedInput.uv2.xy * _RGBA_Mask_B_ST.xy + _RGBA_Mask_B_ST.zw;
				...
				float2 texCoord304 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult320;
				float4 ColorSelection2307 = tex2D( _ColorTheme, texCoord304 );
				float EdgesNoNormals220 = ( packedInput.ase_color.b * _EdgesNormals );
				float4 temp_output_68_0 = ( ColorSelection2307 * pow( ( tex2DNode236.b + EdgesNoNormals220 ) , _DirtDamageOverlay ) );
				float2 uv3_RGBA_Mask_A = packedInput.uv2.xy * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				float4 tex2DNode232 = tex2D( _RGBA_Mask_A, uv3_RGBA_Mask_A );
				float HeightMask10 = saturate(pow(((tex2DNode232.g*( ( ( tex2DNode232.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode232.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				...
				float2 texCoord321 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult323;
				...
				float3 temp_cast_8 = (( 1.0 - packedInput.ase_color.r )).xxx;
				...
				float2 uv3_WallpaperNM = packedInput.uv2.xy * _WallpaperNM_ST.xy + _WallpaperNM_ST.zw;
				...
				float2 uv3_WallpaperDamageNM = packedInput.uv2.xy * _WallpaperDamageNM_ST.xy + _WallpaperDamageNM_ST.zw;
				...
				float3 lerpResult21 = lerp( unpack19 , unpack20 , ( ( Heightmap11 * ( 1.0 - EdgesNoNormals220 ) ) + ( packedInput.ase_color.r * _DamageNormalsExtra ) + CutoutEdges216 ));
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				#endif
				float2 temp_output_298_0 = ( half2( 0.015625,0 ) * staticSwitch325 );
				float2 texCoord301 = packedInput.ase_texcoord2.xy * _ColorsNumber + temp_output_298_0;
				float4 ColorSelection1306 = tex2D( _ColorTheme, texCoord301 );
				float2 appendResult283 = (float2(( _WallpaperNumber * 0.25 ) , ( 0.25 * _WallpaperRow )));
				float2 texCoord282 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + appendResult283;
				float4 tex2DNode167 = tex2D( _PatternTexture, texCoord282 );
				float4 lerpResult170 = lerp( ColorSelection1306 , tex2DNode167 , ( tex2DNode167.a * _PatternStrenght ));
				float2 uv3_RGBA_Mask_B = packedInput.ase_texcoord3.xy * _RGBA_Mask_B_ST.xy + _RGBA_Mask_B_ST.zw;
				float4 tex2DNode236 = tex2D( _RGBA_Mask_B, uv3_RGBA_Mask_B );
				float4 temp_output_33_0 = ( lerpResult170 * pow( tex2DNode236.r , _DirtOverlay ) );
				float2 appendResult320 = (float2(temp_output_298_0.x , 0.5));
				float2 texCoord304 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult320;
				float4 ColorSelection2307 = tex2D( _ColorTheme, texCoord304 );
				float EdgesNoNormals220 = ( packedInput.ase_color.b * _EdgesNormals );
				float4 temp_output_68_0 = ( ColorSelection2307 * pow( ( tex2DNode236.b + EdgesNoNormals220 ) , _DirtDamageOverlay ) );
				float2 uv3_RGBA_Mask_A = packedInput.ase_texcoord3.xy * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				float4 tex2DNode232 = tex2D( _RGBA_Mask_A, uv3_RGBA_Mask_A );
				float HeightMask10 = saturate(pow(((tex2DNode232.g*( ( ( tex2DNode232.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( tex2DNode232.r * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				float Heightmap11 = HeightMask10;
				float4 lerpResult14 = lerp( ( temp_output_33_0 + ( pow( ( tex2DNode236.g + ( tex2DNode236.g * _EdgesOverlayMultiply ) ) , _EdgesOverlayPower ) * temp_output_33_0 ) ) , ( temp_output_68_0 + ( tex2DNode236.a * temp_output_68_0 * _PaperBrightness ) ) , Heightmap11);
				...
				float3 CutoutEdges216 = desaturateVar215;
				float2 appendResult323 = (float2(temp_output_298_0.x , 0.1));
				float2 texCoord321 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult323;
				float4 ColorSelection3312 = tex2D( _ColorTheme, texCoord321 );
				float Mask1_Alpha242 = tex2DNode232.a;
				float3 temp_cast_7 = (( tex2DNode232.b * _DirtMultiplier )).xxx;
				float3 temp_cast_8 = (( 1.0 - packedInput.ase_color.r )).xxx;
				...
				float2 uv3_WallpaperNM = packedInput.ase_texcoord3.xy * _WallpaperNM_ST.xy + _WallpaperNM_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _WallpaperNM, uv3_WallpaperNM ), _WallpaperNMScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_WallpaperNMScale) );
				float2 uv3_WallpaperDamageNM = packedInput.ase_texcoord3.xy * _WallpaperDamageNM_ST.xy + _WallpaperDamageNM_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _WallpaperDamageNM, uv3_WallpaperDamageNM ), _WallpaperDamageNMScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_WallpaperDamageNMScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , ( ( Heightmap11 * ( 1.0 - EdgesNoNormals220 ) ) + ( packedInput.ase_color.r * _DamageNormalsExtra ) + CutoutEdges216 ));
				float3 Normals92 = lerpResult21;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = inputMesh.ase_texcoord2.xy;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
					...
					)
			{
				...
				float RedChannelRGBA109 = tex2DNode232.r;
				float GreenChannelRGBA123 = tex2DNode232.b;
				float3 temp_cast_2 = (( tex2DNode232.b * _DirtMultiplier )).xxx;
		...
		Pass
		{
						...
						)
			{
				...
				#endif
				float2 temp_output_298_0 = ( half2( 0.015625,0 ) * staticSwitch325 );
				float2 texCoord301 = packedInput.ase_texcoord7.xy * _ColorsNumber + temp_output_298_0;
				float4 ColorSelection1306 = tex2D( _ColorTheme, texCoord301 );
				float2 appendResult283 = (float2(( _WallpaperNumber * 0.25 ) , ( 0.25 * _WallpaperRow )));
				float2 texCoord282 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + appendResult283;
				float4 tex2DNode167 = tex2D( _PatternTexture, texCoord282 );
				float4 lerpResult170 = lerp( ColorSelection1306 , tex2DNode167 , ( tex2DNode167.a * _PatternStrenght ));
				float2 uv3_RGBA_Mask_B = packedInput.uv2.xy * _RGBA_Mask_B_ST.xy + _RGBA_Mask_B_ST.zw;
				float4 tex2DNode236 = tex2D( _RGBA_Mask_B, uv3_RGBA_Mask_B );
				float4 temp_output_33_0 = ( lerpResult170 * pow( tex2DNode236.r , _DirtOverlay ) );
				float2 appendResult320 = (float2(temp_output_298_0.x , 0.5));
				float2 texCoord304 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult320;
				float4 ColorSelection2307 = tex2D( _ColorTheme, texCoord304 );
				float EdgesNoNormals220 = ( packedInput.ase_color.b * _EdgesNormals );
				float4 temp_output_68_0 = ( ColorSelection2307 * pow( ( tex2DNode236.b + EdgesNoNormals220 ) , _DirtDamageOverlay ) );
				float2 uv3_RGBA_Mask_A = packedInput.uv2.xy * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				...
				float3 CutoutEdges216 = desaturateVar215;
				float2 appendResult323 = (float2(temp_output_298_0.x , 0.1));
				float2 texCoord321 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult323;
				float4 ColorSelection3312 = tex2D( _ColorTheme, texCoord321 );
				float Mask1_Alpha242 = tex2DNode232.a;
				float3 temp_cast_7 = (( tex2DNode232.b * _DirtMultiplier )).xxx;
				float3 temp_cast_8 = (( 1.0 - packedInput.ase_color.r )).xxx;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1403.153;-60.07813;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;340;2264.035,500.5978;Inherit;False;Property;_Color;Color;36;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;341;2435.035,739.5978;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;338;2224.948,1211.112;Inherit;False;Property;_AlphaClip;Alpha Clip;35;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
WireConnection;327;1;93;0
WireConnection;327;7;118;0
WireConnection;327;9;245;0
WireConnection;327;10;338;0
ASEEND*/
//CHKSM=20C964AB805C44F15AE777C87FE3CF1226301BB5