...
Shader "DBK HDRP/Insulation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _InsulationMask_ST;
			float4 _Color;
			float4 _Normals_ST;
			float _InsulationDarkness;
			int _ColorSelect;
						...
						)
			{
				...
				float2 uv_InsulationMask = packedInput.ase_texcoord5.xy * _InsulationMask_ST.xy + _InsulationMask_ST.zw;
				float4 tex2DNode7 = tex2D( _InsulationMask, uv_InsulationMask );
				float MaskBlue70 = tex2DNode7.b;
				float2 texCoord82 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 ColorUV396 = tex2D( _MainTex, texCoord82 );
				float2 appendResult88 = (float2((float)( _ColorSelect * 0 ) , -0.5));
				float2 texCoord89 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + appendResult88;
				float4 DirtUV395 = tex2D( _MainTex, texCoord89 );
				float3 temp_cast_1 = (( tex2DNode7.g * _DirtMultiplier )).xxx;
				float3 temp_cast_2 = (( 1.0 - packedInput.ase_color.r )).xxx;
				float DirtHeight14 = saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
				float4 lerpResult23 = lerp( ( MaskBlue70 * ( 1.0 - ( _InsulationDarkness * ( 1.0 - packedInput.ase_color.g ) ) ) * ColorUV396 ) , ( DirtUV395 * tex2DNode7.r ) , ( DirtHeight14 * _DirtOpacity ));
				float4 Albedo64 = lerpResult23;
				
				float2 uv_Normals = packedInput.ase_texcoord5.xy * _Normals_ST.xy + _Normals_ST.zw;
				float3 unpack3 = UnpackNormalScale( tex2D( _Normals, uv_Normals ), _NormalsScale );
				unpack3.z = lerp( 1, unpack3.z, saturate(_NormalsScale) );
				float3 Normals59 = unpack3;
				
				float VertexGreen67 = packedInput.ase_color.g;
				clip( tex2DNode7.b - ( VertexGreen67 * _Mask ));
				float Opacity62 = 1.0;
				
				surfaceDescription.Albedo = ( Albedo64 * _Color ).rgb;
				surfaceDescription.Normal = Normals59;
				...
				surfaceDescription.Alpha = Opacity62;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_InsulationMask = packedInput.ase_texcoord2.xy * _InsulationMask_ST.xy + _InsulationMask_ST.zw;
				float4 tex2DNode7 = tex2D( _InsulationMask, uv_InsulationMask );
				float MaskBlue70 = tex2DNode7.b;
				float2 texCoord82 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 ColorUV396 = tex2D( _MainTex, texCoord82 );
				float2 appendResult88 = (float2((float)( _ColorSelect * 0 ) , -0.5));
				float2 texCoord89 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + appendResult88;
				float4 DirtUV395 = tex2D( _MainTex, texCoord89 );
				float3 temp_cast_1 = (( tex2DNode7.g * _DirtMultiplier )).xxx;
				float3 temp_cast_2 = (( 1.0 - packedInput.ase_color.r )).xxx;
				float DirtHeight14 = saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_InsulationMask = packedInput.ase_texcoord1.xy * _InsulationMask_ST.xy + _InsulationMask_ST.zw;
				float4 tex2DNode7 = tex2D( _InsulationMask, uv_InsulationMask );
				float VertexGreen67 = packedInput.ase_color.g;
				clip( tex2DNode7.b - ( VertexGreen67 * _Mask ));
				float Opacity62 = 1.0;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_InsulationMask = packedInput.ase_texcoord3.xy * _InsulationMask_ST.xy + _InsulationMask_ST.zw;
				float4 tex2DNode7 = tex2D( _InsulationMask, uv_InsulationMask );
				float VertexGreen67 = packedInput.ase_color.g;
				clip( tex2DNode7.b - ( VertexGreen67 * _Mask ));
				float Opacity62 = 1.0;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_InsulationMask = packedInput.ase_texcoord7.xy * _InsulationMask_ST.xy + _InsulationMask_ST.zw;
				float4 tex2DNode7 = tex2D( _InsulationMask, uv_InsulationMask );
				float MaskBlue70 = tex2DNode7.b;
				float2 texCoord82 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 ColorUV396 = tex2D( _MainTex, texCoord82 );
				float2 appendResult88 = (float2((float)( _ColorSelect * 0 ) , -0.5));
				float2 texCoord89 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + appendResult88;
				float4 DirtUV395 = tex2D( _MainTex, texCoord89 );
				float3 temp_cast_1 = (( tex2DNode7.g * _DirtMultiplier )).xxx;
				float3 temp_cast_2 = (( 1.0 - packedInput.ase_color.r )).xxx;
				float DirtHeight14 = saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;962.4373;1537.518;2.525886;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;61;-2148.741,-108.3091;Inherit;False;1011.411;280;Comment;3;59;3;4;Normal;0.2142221,0.3497845,0.5471698,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-679.109,1954.241;Inherit;False;Property;_DirtMultiplier;Dirt Multiplier;8;0;Create;True;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;65;629.5379,-44.52966;Inherit;False;64;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;123;800.0448,-107.2627;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-206.52,1947.94;Inherit;False;Property;_DirtRange;Dirt Range;6;0;Create;True;0;0;0;False;0;False;0;0.1069264;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;100;-2061.155,1126.551;Inherit;False;95;DirtUV3;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;7;-1937.101,1851.461;Inherit;True;Property;_InsulationMask;Insulation Mask;4;0;Create;True;0;0;0;False;0;False;-1;722ccb4026ebf614da8f4e012f433fa2;722ccb4026ebf614da8f4e012f433fa2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-210.6329,2048.291;Inherit;False;Property;_DirtSmooth;Dirt Smooth;7;0;Create;True;0;0;0;False;0;False;0;0.3944706;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;78;-2065.438,-1064.777;Inherit;False;Property;_ColorSelect;ColorSelect;0;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-2080.25,822.6673;Inherit;False;Property;_InsulationDarkness;Insulation Darkness;1;0;Create;True;0;0;0;False;0;False;0;0.196;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-2072.74,-0.317816;Inherit;False;Property;_NormalsScale;Normals Scale;3;0;Create;True;0;0;0;False;0;False;0;1.13;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-2178.691,2607.16;Inherit;False;Property;_Mask;Mask;9;0;Create;True;0;0;0;False;0;False;0;0.4;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;71;-1767.626,385.9264;Inherit;False;70;MaskBlue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1125.734,862.3249;Inherit;False;Property;_DirtOpacity;Dirt Opacity;5;0;Create;True;0;0;0;False;0;False;0;0.612;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;106;-1375.463,-1075.801;Inherit;True;Property;_MainTex;Color Theme;10;0;Create;False;0;0;0;False;0;False;4e4a83f3dfdcd8445835fa14af43fa31;4e4a83f3dfdcd8445835fa14af43fa31;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;118;674.6047,134.1797;Inherit;False;Constant;_Smoothness;Smoothness;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;-1729.492,-50.0674;Inherit;True;Property;_Normals;Normals;2;0;Create;False;0;0;0;False;0;False;-1;1e6a95fe5438e044e80289142eedf514;1e6a95fe5438e044e80289142eedf514;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;122;680.0448,-356.2627;Inherit;False;Property;_Color;Color;11;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;107;0;123;0
WireConnection;107;1;60;0
WireConnection;107;7;118;0
WireConnection;107;9;63;0
ASEEND*/
//CHKSM=1147EEEF28E0FF1981BAC04026B687320515B6D6