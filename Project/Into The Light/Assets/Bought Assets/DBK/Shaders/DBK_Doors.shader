	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_DoorsColor = packedInput.ase_texcoord5.xy * _DoorsColor_ST.xy + _DoorsColor_ST.zw;
				...
				float2 texCoord380 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + appendResult378;
				...
				float VertexBlue308 = packedInput.ase_color.b;
				float3 temp_cast_3 = (( 1.0 - VertexBlue308 )).xxx;
				float2 uv3_RGBAMaskB = packedInput.uv2.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				...
				float2 texCoord385 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch376 );
				...
				float HeightMask8 = saturate(pow(((tex2DNode219.g*( ( pow( saferPower56 , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) ))*4)+(( ( pow( saferPower56 , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) )*2),_DamageSmooth));
				...
				float VertexRed234 = packedInput.ase_color.r;
				...
				float2 uv_DoorNM = packedInput.ase_texcoord5.xy * _DoorNM_ST.xy + _DoorNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _DoorNM, uv_DoorNM ), _DoorsNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_DoorsNMScale) );
				float2 uv_DoorDamageNM = packedInput.ase_texcoord5.xy * _DoorDamageNM_ST.xy + _DoorDamageNM_ST.zw;
				...
				surfaceDescription.Albedo = ( Albedo210 * _Color ).rgb;
				surfaceDescription.Normal = Normals208;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Metallic352;
				...
				surfaceDescription.Smoothness = Smoothness260;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DoorsColor = packedInput.ase_texcoord2.xy * _DoorsColor_ST.xy + _DoorsColor_ST.zw;
				float4 tex2DNode150 = tex2D( _DoorsColor, uv_DoorsColor );
				#ifdef _USECUSTOMCOLOR_ON
				float staticSwitch376 = (float)_CustomColor;
				#else
				...
				#endif
				float2 appendResult378 = (float2(( staticSwitch376 * 0.015625 ) , -0.33333));
				float2 texCoord380 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + appendResult378;
				float4 Color2UV3325 = tex2D( _MainTex, texCoord380 );
				...
				float VertexBlue308 = packedInput.ase_color.b;
				float3 temp_cast_3 = (( 1.0 - VertexBlue308 )).xxx;
				float2 uv3_RGBAMaskB = packedInput.ase_texcoord3.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode271 = tex2D( _RGBAMaskB, uv3_RGBAMaskB );
				float3 temp_cast_4 = (pow( ( 1.0 - tex2DNode271.g ) , _TransitionEdgeAmount )).xxx;
				float3 desaturateInitialColor295 = temp_cast_4;
				float desaturateDot295 = dot( desaturateInitialColor295, float3( 0.299, 0.587, 0.114 ));
				...
				float3 CutoutEdges296 = desaturateVar295;
				float4 lerpResult288 = lerp( tex2DNode150 , Color2UV3325 , float4( ( ( 1.0 - saturate( ( 1.0 - ( ( distance( temp_cast_2 , temp_cast_3 ) - _TransitionAmount ) / max( 0.8514541 , 1E-05 ) ) ) ) ) + CutoutEdges296 ) , 0.0 ));
				float2 texCoord385 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch376 );
				float4 Color1UV3327 = tex2D( _MainTex, texCoord385 );
				float MaskRedChannelX369 = tex2DNode219.a;
				float clampResult393 = clamp( ( MaskRedChannelX369 + _WoodGrain ) , 0.0 , 1.0 );
				float4 lerpResult147 = lerp( ( Color1UV3327 * clampResult393 ) , tex2DNode150 , pow( tex2DNode150.a , _MaskOverlay ));
				...
				float2 uv_DoorNM = packedInput.ase_texcoord2.xy * _DoorNM_ST.xy + _DoorNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _DoorNM, uv_DoorNM ), _DoorsNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_DoorsNMScale) );
				float2 uv_DoorDamageNM = packedInput.ase_texcoord2.xy * _DoorDamageNM_ST.xy + _DoorDamageNM_ST.zw;
				float3 unpack2 = UnpackNormalScale( tex2D( _DoorDamageNM, uv_DoorDamageNM ), _DoorsDamageNMScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_DoorsDamageNMScale) );
				float3 lerpResult17 = lerp( unpack4 , unpack2 , DamageSelection212);
				float3 Normals208 = lerpResult17;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord1.xy = inputMesh.ase_texcoord2.xy;
				outputPackedVaryingsMeshToPS.ase_texcoord1.zw = inputMesh.ase_texcoord.xy;
					...
					)
			{
				...
				float2 uv3_RGBAMaskB = packedInput.ase_texcoord1.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode271 = tex2D( _RGBAMaskB, uv3_RGBAMaskB );
				float2 uv_RGBAMaskB = packedInput.ase_texcoord1.zw * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode306 = tex2D( _RGBAMaskB, uv_RGBAMaskB );
				float OpacityMask303 = ( tex2DNode271.g * tex2DNode306.b );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_DoorNM = packedInput.ase_texcoord3.xy * _DoorNM_ST.xy + _DoorNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _DoorNM, uv_DoorNM ), _DoorsNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_DoorsNMScale) );
				float2 uv_DoorDamageNM = packedInput.ase_texcoord3.xy * _DoorDamageNM_ST.xy + _DoorDamageNM_ST.zw;
				float3 unpack2 = UnpackNormalScale( tex2D( _DoorDamageNM, uv_DoorDamageNM ), _DoorsDamageNMScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_DoorsDamageNMScale) );
				...
				float MaskBlueChannel221 = tex2DNode219.b;
				float MaskAlphaChannelX227 = tex2DNode219.r;
				float3 temp_cast_0 = (MaskBlueChannel221).xxx;
				float VertexRed234 = packedInput.ase_color.r;
				float3 temp_cast_1 = (( 1.0 - VertexRed234 )).xxx;
				float temp_output_190_0 = ( ( MaskAlphaChannelX227 * saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_1 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) ) ) * _DirtContrast );
				float DirtSelection248 = temp_output_190_0;
				float Smoothness260 = ( pow( tex2DNode306.r , _MainSmoothness ) * ( 1.0 - ( MaskBlueChannel221 * _SmoothnessOverlay ) ) * ( 1.0 - ( _SmoothnessDirt * DirtSelection248 ) ) * ( 1.0 - ( _SmoothnessDamage * DamageSelection212 ) ) );
				
				float2 uv3_RGBAMaskB = packedInput.ase_texcoord3.zw * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode271 = tex2D( _RGBAMaskB, uv3_RGBAMaskB );
				float OpacityMask303 = ( tex2DNode271.g * tex2DNode306.b );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_DoorsColor = packedInput.ase_texcoord7.xy * _DoorsColor_ST.xy + _DoorsColor_ST.zw;
				float4 tex2DNode150 = tex2D( _DoorsColor, uv_DoorsColor );
				#ifdef _USECUSTOMCOLOR_ON
				float staticSwitch376 = (float)_CustomColor;
				#else
				...
				#endif
				float2 appendResult378 = (float2(( staticSwitch376 * 0.015625 ) , -0.33333));
				float2 texCoord380 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + appendResult378;
				float4 Color2UV3325 = tex2D( _MainTex, texCoord380 );
				...
				float3 CutoutEdges296 = desaturateVar295;
				float4 lerpResult288 = lerp( tex2DNode150 , Color2UV3325 , float4( ( ( 1.0 - saturate( ( 1.0 - ( ( distance( temp_cast_2 , temp_cast_3 ) - _TransitionAmount ) / max( 0.8514541 , 1E-05 ) ) ) ) ) + CutoutEdges296 ) , 0.0 ));
				float2 texCoord385 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch376 );
				float4 Color1UV3327 = tex2D( _MainTex, texCoord385 );
				float MaskRedChannelX369 = tex2DNode219.a;
				float clampResult393 = clamp( ( MaskRedChannelX369 + _WoodGrain ) , 0.0 , 1.0 );
				float4 lerpResult147 = lerp( ( Color1UV3327 * clampResult393 ) , tex2DNode150 , pow( tex2DNode150.a , _MaskOverlay ));
				...
				float2 uv_DoorNM = packedInput.ase_texcoord7.xy * _DoorNM_ST.xy + _DoorNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _DoorNM, uv_DoorNM ), _DoorsNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_DoorsNMScale) );
				float2 uv_DoorDamageNM = packedInput.ase_texcoord7.xy * _DoorDamageNM_ST.xy + _DoorDamageNM_ST.zw;
				float3 unpack2 = UnpackNormalScale( tex2D( _DoorDamageNM, uv_DoorDamageNM ), _DoorsDamageNMScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_DoorsDamageNMScale) );
				float3 lerpResult17 = lerp( unpack4 , unpack2 , DamageSelection212);
				float3 Normals208 = lerpResult17;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-4099.571;672.6818;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;240;-397.5771,203.7377;Inherit;False;2923.793;894.2009;Comment;23;59;11;25;55;64;56;6;63;24;57;7;139;5;234;8;221;18;212;219;308;369;370;368;Damage Selection;0.7735849,0.3224024,0.1715023,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;55;363.2444,478.104;Float;False;Property;_DamagePower;Damage Power;8;0;Create;True;0;0;0;False;0;False;0;0.0624;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;64;479.0524,790.9686;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;234;-30.08225,639.3606;Inherit;False;VertexRed;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;25;340.7904,695.6475;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;59;193.5396,864.6017;Float;False;Property;_DamageMultiply;Damage Multiply;10;0;Create;True;0;0;0;False;0;False;0;0.799;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;219;-366.2261,245.7377;Inherit;True;Property;_RGBAMaskA;RGBA Mask A;20;0;Create;True;0;0;0;False;0;False;-1;5e4e6254e4e8db64fb7226f12b796911;a7856712ad4a5604aafb25d0812d8915;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VertexColorNode;11;-347.5771,664.6511;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;370;1423.53,279.186;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;368;65.03889,265.6452;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;56;660.9089,311.6304;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;63;664.9901,710.2365;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;308;-35.80247,811.2509;Inherit;False;VertexBlue;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;221;79.91946,424.006;Inherit;False;MaskBlueChannel;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;565.4313,976.9388;Float;False;Property;_DamageAmount;Damage Amount;7;0;Create;True;0;0;0;False;0;False;0;0.457;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;57;887.7394,669.3323;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;419;4903.414,-230.4413;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;18;1997.324,472.1826;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;1338.757,683.8811;Float;False;Property;_DamageSmooth;Damage Smooth;9;0;Create;True;0;0;0;False;0;False;0;85.2;0;200;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;369;79.90542,504.6322;Inherit;False;MaskRedChannelX;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;1184.999,521.3355;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;139;1504.443,289.3768;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;200;2363.062,-1214.15;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;947.3434,385.0752;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;201;2334.78,-1051.586;Inherit;False;Property;_DirtContrast;Dirt Contrast;19;0;Create;True;0;0;0;False;0;False;0;1.233938;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;371;-143.7338,-1371.487;Inherit;False;369;MaskRedChannelX;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;274;-76.95824,-2850.498;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.HeightMapBlendNode;8;1716.547,473.9216;Inherit;False;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;212;2237.826,477.2038;Inherit;False;DamageSelection;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;353;4708.78,-100.5061;Inherit;False;352;Metallic;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;209;4713.514,-195.921;Inherit;False;208;Normals;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;261;4706.268,6.072693;Inherit;False;260;Smoothness;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;211;4708.971,-297.0907;Inherit;False;210;Albedo;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;304;4713.563,97.31781;Inherit;False;303;OpacityMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;418;4721.414,-494.4413;Inherit;False;Property;_Color;Color;27;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;406;1;209;0
WireConnection;406;4;353;0
WireConnection;406;7;261;0
WireConnection;406;9;304;0
ASEEND*/
//CHKSM=79C74FC09E61B3A92F3756279EA5D5F33292A5C3