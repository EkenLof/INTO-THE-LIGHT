	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord364 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + appendResult363;
				...
				float2 texCoord412 = packedInput.ase_texcoord5.zw * half2( 0,-0.5 ) + temp_output_420_0;
				...
				float3 temp_cast_3 = (( 1.0 - ( packedInput.ase_color.g * ( 1.0 - tex2DNode290.g ) ) )).xxx;
				...
				float2 texCoord426 = packedInput.ase_texcoord5.zw * half2( 0,0 ) + temp_output_420_0;
				...
				float3 temp_cast_5 = (( 1.0 - ( packedInput.ase_color.r * pow( GreenChannelRGBA123 , _DirtPower ) ) )).xxx;
				...
				float2 uv_NormalGood = packedInput.ase_texcoord5.zw * _NormalGood_ST.xy + _NormalGood_ST.zw;
				...
				float2 uv_NormalDamage = packedInput.ase_texcoord5.zw * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult363 = (float2(( _WallpaperNumber * 0.25 ) , ( 0.25 * _WallpaperRow )));
				float2 texCoord364 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + appendResult363;
				float4 tex2DNode320 = tex2D( _Pattern, texCoord364 );
				#ifdef _USECUSTOMCOLOR1_ON
				float staticSwitch429 = (float)_CustomColor1;
				#else
				...
				#endif
				float2 temp_output_420_0 = ( half2( 0.015625,0 ) * staticSwitch429 );
				float2 texCoord412 = packedInput.ase_texcoord2.zw * half2( 0,-0.5 ) + temp_output_420_0;
				float4 Color1_UV3398 = tex2D( _MainTex, texCoord412 );
				float4 lerpResult314 = lerp( tex2DNode320 , Color1_UV3398 , ( 1.0 - tex2DNode320.a ));
				...
				float Heightmap11 = saturate( ( 1.0 - ( ( distance( temp_cast_3 , float3( 0,0,0 ) ) - _DamageAmount ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult14 = lerp( ( temp_output_33_0 + ( clampResult226 * temp_output_33_0 ) ) , ( temp_output_68_0 + ( pow( ( tex2DNode294.b + ( tex2DNode294.b * _EdgesDamageMultiply ) ) , _EdgesDamagePower ) * temp_output_68_0 ) ) , Heightmap11);
				float2 texCoord426 = packedInput.ase_texcoord2.zw * half2( 0,0 ) + temp_output_420_0;
				float4 Color2_UV3397 = tex2D( _MainTex, texCoord426 );
				float GreenChannelRGBA123 = tex2DNode290.a;
				float3 temp_cast_4 = (( GreenChannelRGBA123 * _DirtMultiplier )).xxx;
				float3 temp_cast_5 = (( 1.0 - ( packedInput.ase_color.r * pow( GreenChannelRGBA123 , _DirtPower ) ) )).xxx;
				...
				float2 uv_NormalGood = packedInput.ase_texcoord2.zw * _NormalGood_ST.xy + _NormalGood_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _NormalGood, uv_NormalGood ), _NormalScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalScale) );
				float2 uv_NormalDamage = packedInput.ase_texcoord2.zw * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _NormalDamage, uv_NormalDamage ), _NormalDamageScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_NormalDamageScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , Heightmap11);
				float3 Normals92 = lerpResult21;
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode290 = tex2D( _RGBAMaskA, uv_RGBAMaskA );
				float3 temp_cast_0 = (( 1.0 - ( packedInput.ase_color.g * ( 1.0 - tex2DNode290.g ) ) )).xxx;
				...
				float TilesMaskBlue291 = tex2DNode290.b;
				float lerpResult268 = lerp( temp_output_102_0 , ( temp_output_102_0 * DirtDamage119 * TilesMaskBlue291 ) , Heightmap11);
				float3 temp_cast_1 = (( GreenChannelRGBA123 * _DirtMultiplier )).xxx;
				float3 temp_cast_2 = (( 1.0 - ( packedInput.ase_color.r * pow( GreenChannelRGBA123 , _DirtPower ) ) )).xxx;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult363 = (float2(( _WallpaperNumber * 0.25 ) , ( 0.25 * _WallpaperRow )));
				float2 texCoord364 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + appendResult363;
				float4 tex2DNode320 = tex2D( _Pattern, texCoord364 );
				#ifdef _USECUSTOMCOLOR1_ON
				float staticSwitch429 = (float)_CustomColor1;
				#else
				...
				#endif
				float2 temp_output_420_0 = ( half2( 0.015625,0 ) * staticSwitch429 );
				float2 texCoord412 = packedInput.ase_texcoord7.zw * half2( 0,-0.5 ) + temp_output_420_0;
				float4 Color1_UV3398 = tex2D( _MainTex, texCoord412 );
				float4 lerpResult314 = lerp( tex2DNode320 , Color1_UV3398 , ( 1.0 - tex2DNode320.a ));
				...
				float Heightmap11 = saturate( ( 1.0 - ( ( distance( temp_cast_3 , float3( 0,0,0 ) ) - _DamageAmount ) / max( 0.0 , 1E-05 ) ) ) );
				float4 lerpResult14 = lerp( ( temp_output_33_0 + ( clampResult226 * temp_output_33_0 ) ) , ( temp_output_68_0 + ( pow( ( tex2DNode294.b + ( tex2DNode294.b * _EdgesDamageMultiply ) ) , _EdgesDamagePower ) * temp_output_68_0 ) ) , Heightmap11);
				float2 texCoord426 = packedInput.ase_texcoord7.zw * half2( 0,0 ) + temp_output_420_0;
				float4 Color2_UV3397 = tex2D( _MainTex, texCoord426 );
				float GreenChannelRGBA123 = tex2DNode290.a;
				float3 temp_cast_4 = (( GreenChannelRGBA123 * _DirtMultiplier )).xxx;
				float3 temp_cast_5 = (( 1.0 - ( packedInput.ase_color.r * pow( GreenChannelRGBA123 , _DirtPower ) ) )).xxx;
				...
				float2 uv_NormalGood = packedInput.ase_texcoord7.zw * _NormalGood_ST.xy + _NormalGood_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _NormalGood, uv_NormalGood ), _NormalScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalScale) );
				float2 uv_NormalDamage = packedInput.ase_texcoord7.zw * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _NormalDamage, uv_NormalDamage ), _NormalDamageScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_NormalDamageScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , Heightmap11);
				float3 Normals92 = lerpResult21;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1871.366;-389.4969;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;445;2430.366,763.4969;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;387;-430.2156,-2480.639;Inherit;False;Property;_ColorSelect;ColorSelect;3;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;183;786.3236,2860.656;Inherit;False;Color Mask;-1;;44;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;444;2325.366,470.4969;Inherit;False;Property;_Color;Color;31;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;104;2232.808,763.5997;Inherit;False;103;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;93;2261.493,892.8726;Inherit;False;92;Normals;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;118;2262.004,1007.073;Inherit;False;117;Smoothness;1;0;OBJECT;0;False;1;FLOAT;0
...
WireConnection;430;1;93;0
WireConnection;430;7;118;0
ASEEND*/
//CHKSM=828AE4444EF9C44A4C859D582C88023C388B0FC4