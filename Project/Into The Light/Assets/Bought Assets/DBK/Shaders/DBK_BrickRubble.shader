	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_4 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord5.xy * temp_cast_4 + float2( 0,0 );
				...
				float3 unpack5 = UnpackNormalScale( tex2D( _BakedNM, uv_BakedNM ), _BakedNMScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BakedNMScale) );
				...
				float3 Normals94 = BlendNormal( unpack5 , unpack21 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 Color1UV381 = tex2D( _ColorTheme, texCoord77 );
				float2 temp_cast_4 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord2.xy * temp_cast_4 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_5 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
		...
		Pass
		{
						...
						)
			{
				...
				float4 Color1UV381 = tex2D( _ColorTheme, texCoord77 );
				float2 temp_cast_4 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord7.xy * temp_cast_4 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_5 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-888.3561;508.0842;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;133;-906.0053,829.848;Inherit;True;Property;_MainTex;Mask A;8;0;Create;False;0;0;0;False;0;False;-1;248f2238564ce0943aaa20442904dc0a;248f2238564ce0943aaa20442904dc0a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;184;1808.356,319.9158;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;144;1593.416,304.681;Inherit;False;143;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-2372.607,1584.546;Inherit;False;Property;_BakedNMScale;Baked NM Scale;18;0;Create;True;0;0;0;False;0;False;0;1.235294;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;1582.362,698.6448;Inherit;False;Property;_AlphaClip;Alpha Clip;19;0;Create;True;0;0;0;False;0;False;0;0.594;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;164;1636.208,499.7929;Inherit;False;163;Smoothnes;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;142;1634.354,559.0516;Inherit;False;136;Mask_A_Alpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;183;1590.356,6.915771;Inherit;False;Property;_Color;Color;20;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;170;0;184;0
WireConnection;170;1;95;0
WireConnection;170;7;164;0
WireConnection;170;9;142;0
WireConnection;170;10;181;0
ASEEND*/
//CHKSM=3F62130F4BB12256C5EC59402486F8BF9BB74E4F