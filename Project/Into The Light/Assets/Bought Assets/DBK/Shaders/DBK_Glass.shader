...
Shader "DBK HDRP/Glass"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_GlassSmoothness("Glass Smoothness", Range( 0 , 1)) = 0
		...
		_AlphaClip("Alpha Clip", Range( 0 , 1)) = 0.2510513
		_AlphaPrepass("Alpha Prepass", Range( 0 , 1)) = 0.02352942
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color;
			float4 _Glass_Normals_ST;
			int _ColorSelect;
			float _GlassBrigthness;
						...
						)
			{
				...
				float2 uv_GlassMask = packedInput.ase_texcoord5.xy * _GlassMask_ST.xy + _GlassMask_ST.zw;
				float4 tex2DNode65 = tex2D( _GlassMask, uv_GlassMask );
				float2 texCoord55 = packedInput.ase_texcoord5.xy * half2( 0,-0.1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 ColorSelection63 = tex2D( _ColorTheme, texCoord55 );
				
				float2 uv_Glass_Normals = packedInput.ase_texcoord5.xy * _Glass_Normals_ST.xy + _Glass_Normals_ST.zw;
				
				surfaceDescription.Albedo = ( ( tex2DNode65.r * ColorSelection63 * _GlassBrigthness ) * _Color ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _Glass_Normals, uv_Glass_Normals ), 1.0f );
				...
				surfaceDescription.Smoothness = ( _GlassSmoothness * ( _DirtSmoothness * tex2DNode65.r ) );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( tex2DNode65.b * ( 1.0 - ( tex2DNode65.r * _DirtOpacity ) ) );
				...
				surfaceDescription.AlphaClipThresholdDepthPrepass = _AlphaPrepass;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_GlassMask = packedInput.ase_texcoord2.xy * _GlassMask_ST.xy + _GlassMask_ST.zw;
				float4 tex2DNode65 = tex2D( _GlassMask, uv_GlassMask );
				float2 texCoord55 = packedInput.ase_texcoord2.xy * half2( 0,-0.1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 ColorSelection63 = tex2D( _ColorTheme, texCoord55 );
				
				float2 uv_Glass_Normals = packedInput.ase_texcoord2.xy * _Glass_Normals_ST.xy + _Glass_Normals_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_GlassMask = packedInput.ase_texcoord1.xy * _GlassMask_ST.xy + _GlassMask_ST.zw;
				float4 tex2DNode65 = tex2D( _GlassMask, uv_GlassMask );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Glass_Normals = packedInput.ase_texcoord3.xy * _Glass_Normals_ST.xy + _Glass_Normals_ST.zw;
				
				float2 uv_GlassMask = packedInput.ase_texcoord3.xy * _GlassMask_ST.xy + _GlassMask_ST.zw;
				float4 tex2DNode65 = tex2D( _GlassMask, uv_GlassMask );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_GlassMask = packedInput.ase_texcoord7.xy * _GlassMask_ST.xy + _GlassMask_ST.zw;
				float4 tex2DNode65 = tex2D( _GlassMask, uv_GlassMask );
				float2 texCoord55 = packedInput.ase_texcoord7.xy * half2( 0,-0.1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 ColorSelection63 = tex2D( _ColorTheme, texCoord55 );
				
				float2 uv_Glass_Normals = packedInput.ase_texcoord7.xy * _Glass_Normals_ST.xy + _Glass_Normals_ST.zw;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-459.489;676.6133;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;56;-8.107996,-1452.065;Inherit;True;Property;_ColorTheme;Color Theme;2;0;Create;True;0;0;0;False;0;False;cd4b5d8aeef219c4bafd11ce2d4d5525;cd4b5d8aeef219c4bafd11ce2d4d5525;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;14;-442.726,847.6392;Inherit;False;Property;_DirtOpacity;Dirt Opacity;1;0;Create;True;0;0;0;False;0;False;0;0.465;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-424.538,247.9246;Inherit;False;Property;_DirtSmoothness;Dirt Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0.875;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;63;815.8384,-1459.527;Inherit;False;ColorSelection;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;96;1234.489,-285.6133;Inherit;False;Property;_Color;Color;11;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;50;-742.0428,-1292.712;Inherit;False;Property;_ColorSelect;ColorSelect;10;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;1;False;0;1;INT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;315.8699,240.284;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;65;-467.2832,-285.9327;Inherit;True;Property;_GlassMask;Glass Mask;6;0;Create;True;0;0;0;False;0;False;-1;bfbde71c1a80a6f448fd18fc39306db8;bfbde71c1a80a6f448fd18fc39306db8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;92;1229.082,320.6261;Inherit;False;Property;_AlphaPrepass;Alpha Prepass;9;0;Create;True;0;0;0;False;0;False;0.02352942;0.458;0;1;0;1;FLOAT;0
...
WireConnection;80;7;18;0
WireConnection;80;9;11;0
WireConnection;80;10;78;0
WireConnection;80;33;92;0
ASEEND*/
//CHKSM=41A018FD80A361BAF05D78F2CB17068E99120D2C