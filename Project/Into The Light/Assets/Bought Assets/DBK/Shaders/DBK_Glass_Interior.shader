...
Shader "DBK HDRP/GlassInterioir"
{
	Properties
	{
		...
		_WallBrightness("Wall Brightness", Range( 0 , 0.2)) = 0.03536104
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_WallTex = packedInput.ase_texcoord5.xy * _WallTex_ST.xy + _WallTex_ST.zw;
				float2 uv_MainTex149 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode149 = tex2D( _MainTex, uv_MainTex149 );
				float2 texCoord164 = packedInput.ase_texcoord5.xy * half2( 0,-0.1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 lerpResult152 = lerp( ( _WallBrightness * tex2D( _WallTex, uv_WallTex ) ) , ( tex2DNode149.r * tex2D( _ColorTheme, texCoord164 ) ) , tex2DNode149.g);
				
				float2 uv_GlassNM = packedInput.ase_texcoord5.xy * _GlassNM_ST.xy + _GlassNM_ST.zw;
				
				surfaceDescription.Albedo = ( lerpResult152 * _Color ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _GlassNM, uv_GlassNM ), 1.0f );
				...
				surfaceDescription.Smoothness = ( tex2DNode149.r * _SmoothnessValue );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_WallTex = packedInput.ase_texcoord2.xy * _WallTex_ST.xy + _WallTex_ST.zw;
				float2 uv_MainTex149 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode149 = tex2D( _MainTex, uv_MainTex149 );
				float2 texCoord164 = packedInput.ase_texcoord2.xy * half2( 0,-0.1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 lerpResult152 = lerp( ( _WallBrightness * tex2D( _WallTex, uv_WallTex ) ) , ( tex2DNode149.r * tex2D( _ColorTheme, texCoord164 ) ) , tex2DNode149.g);
				
				float2 uv_GlassNM = packedInput.ase_texcoord2.xy * _GlassNM_ST.xy + _GlassNM_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_GlassNM = packedInput.ase_texcoord3.xy * _GlassNM_ST.xy + _GlassNM_ST.zw;
				
				float2 uv_MainTex149 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode149 = tex2D( _MainTex, uv_MainTex149 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_WallTex = packedInput.ase_texcoord7.xy * _WallTex_ST.xy + _WallTex_ST.zw;
				float2 uv_MainTex149 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode149 = tex2D( _MainTex, uv_MainTex149 );
				float2 texCoord164 = packedInput.ase_texcoord7.xy * half2( 0,-0.1 ) + ( half2( 0.015625,0 ) * _ColorSelect );
				float4 lerpResult152 = lerp( ( _WallBrightness * tex2D( _WallTex, uv_WallTex ) ) , ( tex2DNode149.r * tex2D( _ColorTheme, texCoord164 ) ) , tex2DNode149.g);
				
				float2 uv_GlassNM = packedInput.ase_texcoord7.xy * _GlassNM_ST.xy + _GlassNM_ST.zw;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-4351.961;2760.367;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;179;3869.102,-1919.546;Inherit;False;Property;_WallBrightness;Wall Brightness;18;0;Create;True;0;0;0;False;0;False;0.03536104;0;0;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;180;3845.159,-1743.309;Inherit;True;Property;_WallTex;WallTex;19;0;Create;True;0;0;0;False;0;False;-1;254607d38a149b34686722576dbdcc96;254607d38a149b34686722576dbdcc96;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;181;4220.159,-1920.309;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;184;5383.934,-2233.969;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;16;-563.261,427.9094;Float;False;Property;_SwitchPlane;Switch Plane;18;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-717.3125,-1608.731;Float;False;Property;_FloorTexTiling;Floor Tex Tiling;6;0;Create;True;0;0;0;False;0;False;0.2301815;0.15;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;122;-172.1613,-849.3633;Inherit;True;Property;_Back;Back;10;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;254607d38a149b34686722576dbdcc96;254607d38a149b34686722576dbdcc96;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-717.3125,-1432.731;Float;False;Property;_CeilingTexTiling;Ceiling Tex Tiling;13;0;Create;True;0;0;0;False;0;False;12.94118;0.15;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;138;3346.549,-1495.357;Float;False;Property;_RoomIntensity;Room Intensity;0;0;Create;True;0;0;0;False;0;False;0.25;0.057;0;0.25;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;183;5208.934,-2467.969;Inherit;False;Property;_Color;Color;20;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ComponentMaskNode;108;-643.3125,-1733.731;Inherit;False;True;False;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0
...
WireConnection;168;0;184;0
WireConnection;168;1;157;0
WireConnection;168;7;151;0
ASEEND*/
//CHKSM=13C875C37F583548390C869564A91708766EAAC0