...
Shader "DBK HDRP/CinderblockRubbleTile"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_Displacement("Displacement", Range( 0 , 1)) = 0.2
		...
		_BrickTileNM("Brick Tile NM", 2D) = "bump" {}
		_BrickNMScale("Brick NM Scale", Range( 1 , 2)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_MainTex1 = inputMesh.ase_texcoord.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( uv_MainTex1, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = inputMesh.ase_color.b;
				float3 temp_cast_0 = (VertexBlue194).xxx;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = inputMesh.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				...
				float3 Tessalation205 = ( ( Mask_A_Alpha136 * inputMesh.normalOS ) * _Displacement * temp_output_202_0 * temp_output_202_0 );
						...
						)
			{
				...
				float2 texCoord80 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 uv_MainTex1 = packedInput.ase_texcoord5.zw * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
				float Mask_A_Red134 = tex2DNode133.r;
				float2 texCoord77 = packedInput.ase_texcoord5.xy * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord5.zw * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				float VertexGreen63 = packedInput.ase_color.g;
				...
				float2 texCoord85 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult87;
				float4 Color2UV386 = tex2D( _MainTex, texCoord85 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float VertexRed62 = packedInput.ase_color.r;
				...
				float2 uv_BrickTileNM = packedInput.ase_texcoord5.zw * _BrickTileNM_ST.xy + _BrickTileNM_ST.zw;
				float3 unpack217 = UnpackNormalScale( tex2D( _BrickTileNM, uv_BrickTileNM ), _BrickNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BrickNMScale) );
				...
				float VertexBlue194 = packedInput.ase_color.b;
				...
				surfaceDescription.Albedo = ( Albedo143 * _Color ).rgb;
				surfaceDescription.Normal = Normals94;
				...
				surfaceDescription.Smoothness = Smoothnes163;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 uv_MainTex1 = inputMesh.uv0.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( uv_MainTex1, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = inputMesh.ase_color.b;
				float3 temp_cast_0 = (VertexBlue194).xxx;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = inputMesh.uv0.xy * temp_cast_1 + float2( 0,0 );
				float4 tex2DNode55 = tex2Dlod( _MaskB, float4( texCoord89, 0, 0.0) );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_2 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_2 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , 0.1));
				float2 texCoord80 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 uv_MainTex1 = packedInput.ase_texcoord2.zw * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
				float Mask_A_Red134 = tex2DNode133.r;
				float2 texCoord77 = packedInput.ase_texcoord2.xy * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord2.zw * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float4 lerpResult126 = lerp( ( Color383 * Mask_A_Red134 ) , Color1UV381 , PaintSelection119);
				float2 appendResult87 = (float2(temp_output_74_0.x , 0.5));
				float2 texCoord85 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult87;
				float4 Color2UV386 = tex2D( _MainTex, texCoord85 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float VertexRed62 = packedInput.ase_color.r;
				float3 temp_cast_7 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
				...
				float2 uv_BrickTileNM = packedInput.ase_texcoord2.zw * _BrickTileNM_ST.xy + _BrickTileNM_ST.zw;
				float3 unpack217 = UnpackNormalScale( tex2D( _BrickTileNM, uv_BrickTileNM ), _BrickNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BrickNMScale) );
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
		...
		Pass
		{
					...
					)
			{
				...
				float3 temp_cast_0 = (VertexBlue194).xxx;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord1.xy * temp_cast_1 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_2 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_2 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BrickTileNM = packedInput.ase_texcoord3.xy * _BrickTileNM_ST.xy + _BrickTileNM_ST.zw;
				float3 unpack217 = UnpackNormalScale( tex2D( _BrickTileNM, uv_BrickTileNM ), _BrickNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BrickNMScale) );
				float2 temp_cast_0 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
				unpack21.z = lerp( 1, unpack21.z, saturate(_DetailsNMScale) );
				float3 Normals94 = BlendNormal( unpack217 , unpack21 );
				...
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_1 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				float VertexGreen63 = packedInput.ase_color.g;
				float3 temp_cast_2 = (( Mask_B_Green57 * VertexGreen63 )).xxx;
				float Mask_A_Green137 = tex2DNode133.g;
				float PaintSelection119 = ( saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _PaintRange ) / max( _PaintSmooth , 1E-05 ) ) ) ) * Mask_A_Green137 );
				float VertexRed62 = packedInput.ase_color.r;
				float Mask_B_Alpha59 = tex2DNode55.a;
				float3 temp_cast_3 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult51 = clamp( ( saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) ) * _DirtContrast ) , 0.0 , 1.0 );
				float DirtSelection52 = clampResult51;
				float Smoothnes163 = ( ( ( Mask_A_Red134 * _MainSmoothness ) + ( _PaintSmoothness * PaintSelection119 ) ) * ( 1.0 - DirtSelection52 ) );
				
				float VertexBlue194 = packedInput.ase_color.b;
				float3 temp_cast_5 = (VertexBlue194).xxx;
				float3 temp_cast_6 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_5 , temp_cast_6 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
				float AlphaSelection189 = clampResult188;
				float temp_output_202_0 = ( 1.0 - AlphaSelection189 );
				float AlphaMap208 = temp_output_202_0;
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , 0.1));
				float2 texCoord80 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 uv_MainTex1 = packedInput.ase_texcoord7.zw * _MainTex1_ST.xy + _MainTex1_ST.zw;
				float4 tex2DNode133 = tex2D( _MainTex1, uv_MainTex1 );
				float Mask_A_Red134 = tex2DNode133.r;
				float2 texCoord77 = packedInput.ase_texcoord7.xy * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord7.zw * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float4 lerpResult126 = lerp( ( Color383 * Mask_A_Red134 ) , Color1UV381 , PaintSelection119);
				float2 appendResult87 = (float2(temp_output_74_0.x , 0.5));
				float2 texCoord85 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult87;
				float4 Color2UV386 = tex2D( _MainTex, texCoord85 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float VertexRed62 = packedInput.ase_color.r;
				float3 temp_cast_7 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
				...
				float2 uv_BrickTileNM = packedInput.ase_texcoord7.zw * _BrickTileNM_ST.xy + _BrickTileNM_ST.zw;
				float3 unpack217 = UnpackNormalScale( tex2D( _BrickTileNM, uv_BrickTileNM ), _BrickNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BrickNMScale) );
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1868.243;212.2405;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;73;-1314.66,-1236.519;Half;False;Constant;_NumberOfColors;NumberOfColors;21;0;Create;True;0;0;0;False;1;;False;0.015625,0;0.125,0.73;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;55;-1689.782,842.0186;Inherit;True;Property;_MaskB;Mask B;9;0;Create;True;0;0;0;False;0;False;-1;5b71a3cf759201643b7d66aa9084dbd4;5b71a3cf759201643b7d66aa9084dbd4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;75;-867.5462,-1281.693;Half;False;Property;_ColorsNumber;ColorsNumber;15;0;Create;True;0;0;0;False;1;;False;0,-0.08;0.015625,-0.056;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.StaticSwitch;72;-1313.295,-942.8968;Inherit;False;Property;_UseCustomColor;Use Custom Color;17;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;133;-906.0053,829.848;Inherit;True;Property;_MainTex1;Mask A;8;0;Create;False;0;0;0;False;0;False;-1;42e76383800765b4883fbf88468d3d60;42e76383800765b4883fbf88468d3d60;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-760.0119,1899.403;Inherit;False;Property;_PaintRange;Paint Range;2;0;Create;True;0;0;0;False;0;False;0;0.64755;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;76;-512.2083,-1111.84;Inherit;True;Property;_MainTex;Color Theme;1;0;Create;False;0;0;0;False;0;False;fb0e05ef0dc56c643af47507dafa28c9;fb0e05ef0dc56c643af47507dafa28c9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.GetLocalVarNode;144;2408.374,211.4877;Inherit;False;143;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;2725.391,1695.693;Inherit;False;Property;_DirtContrast;Dirt Contrast;12;0;Create;True;0;0;0;False;0;False;0;1.010981;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;182;855.859,2689.127;Inherit;False;Property;_CutAlphaSmooth;Cut Alpha Smooth;21;0;Create;True;0;0;0;False;1;MaxGay;False;0;1.423529;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;70;-1516.417,-1061.846;Inherit;False;Property;_ColorSelect;ColorSelect;4;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;48;2693.391,1471.694;Inherit;False;Color Mask;-1;;48;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;2261.39,1743.693;Inherit;False;Property;_DirtSmooth;Dirt Smooth;10;0;Create;True;0;0;0;False;1;MaxGay;False;0;0.8348978;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;183;827.8595,2592.128;Inherit;False;Property;_CutAlphaRange;Cut Alpha Range;22;0;Create;True;0;0;0;False;0;False;0;0.07344181;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;71;-1533.295,-906.8967;Inherit;False;Property;_CustomColor;Custom Color;18;0;Create;True;0;0;0;False;0;False;0;24;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;2277.391,1679.693;Inherit;False;Property;_DirtRange;Dirt Range;11;0;Create;True;0;0;0;False;0;False;0;0.213007;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;185;1263.857,2380.128;Inherit;False;Color Mask;-1;;50;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-760.1808,1995.766;Inherit;False;Property;_PaintSmooth;Paint Smooth;3;0;Create;True;0;0;0;False;0;False;0;0.06668227;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;234;2639.243,206.7594;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;1079.862,-1104.907;Inherit;False;Property;_MainSmoothness;Main Smoothness;14;0;Create;True;0;0;0;False;0;False;0;0.1068977;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;1550.841,-863.9733;Inherit;False;Property;_PaintSmoothness;Paint Smoothness;16;0;Create;True;0;0;0;False;0;False;0;0.1573163;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-2469.783,1550.812;Inherit;False;Property;_BrickNMScale;Brick NM Scale;20;0;Create;True;0;0;0;False;0;False;1;1.100135;1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-2422.818,1861.233;Inherit;False;Property;_DetailsNMScale;Details NM Scale;6;0;Create;True;0;0;0;False;0;False;0;0.3822926;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-113.1507,340.9817;Inherit;False;Property;_DirtBrightness;Dirt Brightness;13;0;Create;True;0;0;0;False;0;False;0;0.1173936;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;217;-2152.783,1484.812;Inherit;True;Property;_BrickTileNM;Brick Tile NM;19;0;Create;True;0;0;0;False;0;False;-1;dc820580967230744910ba914b8a57f2;7b511ab90838e7242a50fcf139971129;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;171;1075.518,1906.409;Float;False;Property;_Displacement;Displacement;0;0;Create;True;0;0;0;False;0;False;0.2;0.159;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;231;2534.34,748.0284;Inherit;False;Constant;_AlphaClip;Alpha Clip;25;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;233;2425.243,-42.2406;Inherit;False;Property;_Color;Color;23;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;220;0;234;0
WireConnection;220;1;95;0
WireConnection;220;7;164;0
WireConnection;220;9;209;0
WireConnection;220;10;231;0
WireConnection;220;11;206;0
ASEEND*/
//CHKSM=A91AD96F6F75121199D458066A852DFE46119C2E