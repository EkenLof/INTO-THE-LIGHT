	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord385 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float2 ConcreteTileUV386 = texCoord385;
				...
				#else
				float staticSwitch635 = (float)_ColorSelect;
				#endif
				float2 appendResult613 = (float2(( staticSwitch635 * 0.015625 ) , -0.33));
				float2 texCoord611 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + appendResult613;
				float4 BareConcrete622 = tex2D( _MainTex, texCoord611 );
				float4 temp_output_559_0 = ( ConcreteNewAlpha640 * BareConcrete622 * _BareBrightness );
				float HeightMask58 = saturate(pow(((( 1.0 - tex2DNode636.r )*( _DamageAmount * ( ( packedInput.ase_color.g * _DamageMultiplier ) * tex2DNode636.g ) ))*4)+(( _DamageAmount * ( ( packedInput.ase_color.g * _DamageMultiplier ) * tex2DNode636.g ) )*2),_DamageAmountSmooth));
				...
				float2 texCoord612 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch635 );
				float4 PaintColor619 = tex2D( _MainTex, texCoord612 );
				float HeightGreen564 = tex2DNode636.b;
				float3 temp_cast_3 = (( 1.0 - HeightGreen564 )).xxx;
				float VertexBlue392 = packedInput.ase_color.b;
				...
				float2 texCoord627 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + appendResult628;
				float4 DirtColor630 = tex2D( _MainTex, texCoord627 );
				float VertexRed336 = packedInput.ase_color.r;
				...
				float2 uv_ConcreteNM = packedInput.ase_texcoord5.xy * _ConcreteNM_ST.xy + _ConcreteNM_ST.zw;
				float2 uv_TransitionNM = packedInput.ase_texcoord5.xy * _TransitionNM_ST.xy + _TransitionNM_ST.zw;
				float3 unpack10 = UnpackNormalScale( tex2D( _TransitionNM, uv_TransitionNM ), _TransitionScale );
				unpack10.z = lerp( 1, unpack10.z, saturate(_TransitionScale) );
				float3 lerpResult1 = lerp( UnpackNormalScale( tex2D( _ConcreteNM, uv_ConcreteNM ), 1.0f ) , unpack10 , BricksStep210);
				float3 unpack69 = UnpackNormalScale( tex2D( _DamageNM, ConcreteTileUV386 ), _ConcreteDamageScale );
				unpack69.z = lerp( 1, unpack69.z, saturate(_ConcreteDamageScale) );
				float3 lerpResult68 = lerp( lerpResult1 , unpack69 , HeightBricks203);
				...
				surfaceDescription.Albedo = ( Albedo323 * _Color ).rgb;
				surfaceDescription.Normal = Normals320;
				...
				surfaceDescription.Smoothness = Smoothness359;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_ConcreteDamageTiling).xx;
				float2 texCoord385 = packedInput.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 ConcreteTileUV386 = texCoord385;
				float4 tex2DNode185 = tex2D( _DamageColor, ConcreteTileUV386 );
				...
				#endif
				float2 appendResult613 = (float2(( staticSwitch635 * 0.015625 ) , -0.33));
				float2 texCoord611 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + appendResult613;
				float4 BareConcrete622 = tex2D( _MainTex, texCoord611 );
				float4 temp_output_559_0 = ( ConcreteNewAlpha640 * BareConcrete622 * _BareBrightness );
				float HeightMask58 = saturate(pow(((( 1.0 - tex2DNode636.r )*( _DamageAmount * ( ( packedInput.ase_color.g * _DamageMultiplier ) * tex2DNode636.g ) ))*4)+(( _DamageAmount * ( ( packedInput.ase_color.g * _DamageMultiplier ) * tex2DNode636.g ) )*2),_DamageAmountSmooth));
				float HeightBricks203 = HeightMask58;
				float BricksStep210 = step( 0.1 , ( ( 1.0 - HeightBricks203 ) * step( _TransitionAmount , HeightBricks203 ) ) );
				float4 lerpResult459 = lerp( ( tex2DNode185 * _DamageBrightness ) , ( ( temp_output_559_0 + tex2DNode185 ) * _TransitionBrightness * ConcreteNewAlpha640 ) , BricksStep210);
				float2 texCoord612 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch635 );
				float4 PaintColor619 = tex2D( _MainTex, texCoord612 );
				float HeightGreen564 = tex2DNode636.b;
				float3 temp_cast_3 = (( 1.0 - HeightGreen564 )).xxx;
				float VertexBlue392 = packedInput.ase_color.b;
				...
				float4 lerpResult117 = lerp( lerpResult459 , ( ( lerpResult397 + ( lerpResult397 * _EdgesOverlay * tex2DNode325.g ) ) * temp_output_228_0 ) , PaintSelection313);
				float2 appendResult628 = (float2(( staticSwitch635 * 0.015625 ) , -0.66));
				float2 texCoord627 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + appendResult628;
				float4 DirtColor630 = tex2D( _MainTex, texCoord627 );
				float VertexRed336 = packedInput.ase_color.r;
				float3 temp_cast_5 = (( VertexRed336 * ( 1.0 - tex2DNode325.g ) )).xxx;
				float3 temp_cast_6 = (( 1.0 - HeightGreen564 )).xxx;
				...
				float2 uv_ConcreteNM = packedInput.ase_texcoord2.xy * _ConcreteNM_ST.xy + _ConcreteNM_ST.zw;
				float2 uv_TransitionNM = packedInput.ase_texcoord2.xy * _TransitionNM_ST.xy + _TransitionNM_ST.zw;
				float3 unpack10 = UnpackNormalScale( tex2D( _TransitionNM, uv_TransitionNM ), _TransitionScale );
				unpack10.z = lerp( 1, unpack10.z, saturate(_TransitionScale) );
				float3 lerpResult1 = lerp( UnpackNormalScale( tex2D( _ConcreteNM, uv_ConcreteNM ), 1.0f ) , unpack10 , BricksStep210);
				float3 unpack69 = UnpackNormalScale( tex2D( _DamageNM, ConcreteTileUV386 ), _ConcreteDamageScale );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_ConcreteNM = packedInput.ase_texcoord3.xy * _ConcreteNM_ST.xy + _ConcreteNM_ST.zw;
				...
				float3 lerpResult1 = lerp( UnpackNormalScale( tex2D( _ConcreteNM, uv_ConcreteNM ), 1.0f ) , unpack10 , BricksStep210);
				float2 temp_cast_0 = (_ConcreteDamageTiling).xx;
				float2 texCoord385 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 ConcreteTileUV386 = texCoord385;
				float3 unpack69 = UnpackNormalScale( tex2D( _DamageNM, ConcreteTileUV386 ), _ConcreteDamageScale );
				unpack69.z = lerp( 1, unpack69.z, saturate(_ConcreteDamageScale) );
				float3 lerpResult68 = lerp( lerpResult1 , unpack69 , HeightBricks203);
				...
				float PaintSmoothness351 = temp_output_228_0;
				float VertexRed336 = packedInput.ase_color.r;
				float3 temp_cast_1 = (( VertexRed336 * ( 1.0 - tex2DNode325.g ) )).xxx;
				float HeightGreen564 = tex2DNode636.b;
				float3 temp_cast_2 = (( 1.0 - HeightGreen564 )).xxx;
				float temp_output_309_0 = ( ( tex2DNode325.a * saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_2 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) ) ) * _DirtContrast );
				float DirtSmothness366 = temp_output_309_0;
				float3 temp_cast_3 = (( 1.0 - HeightGreen564 )).xxx;
				float VertexBlue392 = packedInput.ase_color.b;
				float DirtMaskBlue413 = tex2DNode325.b;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_ConcreteDamageTiling).xx;
				float2 texCoord385 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float2 ConcreteTileUV386 = texCoord385;
				float4 tex2DNode185 = tex2D( _DamageColor, ConcreteTileUV386 );
				...
				#endif
				float2 appendResult613 = (float2(( staticSwitch635 * 0.015625 ) , -0.33));
				float2 texCoord611 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + appendResult613;
				float4 BareConcrete622 = tex2D( _MainTex, texCoord611 );
				float4 temp_output_559_0 = ( ConcreteNewAlpha640 * BareConcrete622 * _BareBrightness );
				float HeightMask58 = saturate(pow(((( 1.0 - tex2DNode636.r )*( _DamageAmount * ( ( packedInput.ase_color.g * _DamageMultiplier ) * tex2DNode636.g ) ))*4)+(( _DamageAmount * ( ( packedInput.ase_color.g * _DamageMultiplier ) * tex2DNode636.g ) )*2),_DamageAmountSmooth));
				float HeightBricks203 = HeightMask58;
				float BricksStep210 = step( 0.1 , ( ( 1.0 - HeightBricks203 ) * step( _TransitionAmount , HeightBricks203 ) ) );
				float4 lerpResult459 = lerp( ( tex2DNode185 * _DamageBrightness ) , ( ( temp_output_559_0 + tex2DNode185 ) * _TransitionBrightness * ConcreteNewAlpha640 ) , BricksStep210);
				float2 texCoord612 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch635 );
				float4 PaintColor619 = tex2D( _MainTex, texCoord612 );
				float HeightGreen564 = tex2DNode636.b;
				float3 temp_cast_3 = (( 1.0 - HeightGreen564 )).xxx;
				float VertexBlue392 = packedInput.ase_color.b;
				...
				float4 lerpResult117 = lerp( lerpResult459 , ( ( lerpResult397 + ( lerpResult397 * _EdgesOverlay * tex2DNode325.g ) ) * temp_output_228_0 ) , PaintSelection313);
				float2 appendResult628 = (float2(( staticSwitch635 * 0.015625 ) , -0.66));
				float2 texCoord627 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + appendResult628;
				float4 DirtColor630 = tex2D( _MainTex, texCoord627 );
				float VertexRed336 = packedInput.ase_color.r;
				float3 temp_cast_5 = (( VertexRed336 * ( 1.0 - tex2DNode325.g ) )).xxx;
				float3 temp_cast_6 = (( 1.0 - HeightGreen564 )).xxx;
				...
				float2 uv_ConcreteNM = packedInput.ase_texcoord7.xy * _ConcreteNM_ST.xy + _ConcreteNM_ST.zw;
				float2 uv_TransitionNM = packedInput.ase_texcoord7.xy * _TransitionNM_ST.xy + _TransitionNM_ST.zw;
				float3 unpack10 = UnpackNormalScale( tex2D( _TransitionNM, uv_TransitionNM ), _TransitionScale );
				unpack10.z = lerp( 1, unpack10.z, saturate(_TransitionScale) );
				float3 lerpResult1 = lerp( UnpackNormalScale( tex2D( _ConcreteNM, uv_ConcreteNM ), 1.0f ) , unpack10 , BricksStep210);
				float3 unpack69 = UnpackNormalScale( tex2D( _DamageNM, ConcreteTileUV386 ), _ConcreteDamageScale );
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-2604.827;831.9397;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;354;2958.271,-423.3109;Inherit;False;187;120;Albedo;1;324;;0.9150943,0.7239427,0.0302154,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;636;-310.4765,737.7122;Inherit;True;Property;_RGBAMaskB;RGBA Mask B;22;0;Create;True;0;0;0;False;0;False;-1;0cc5a2d9845f1c243a311cd5fe2d190e;0cc5a2d9845f1c243a311cd5fe2d190e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;639;499.3073,1014.933;Float;False;Property;_DamageMultiplier;Damage Multiplier;7;0;Create;True;0;0;0;False;0;False;0.1946161;0.7882353;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;524;-2304.521,-2702.86;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;424;-2735.879,-2396.239;Inherit;False;Property;_ConcreteBareRange;Concrete Bare Range;13;0;Create;True;0;0;0;False;0;False;0;0.65;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;432;-2337.99,-2521.934;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;425;-2731.513,-2316.262;Inherit;False;Property;_ConcreteBareSmooth;Concrete Bare Smooth;14;0;Create;True;0;0;0;False;0;False;0;0.267;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;624;-748.9025,-3489.662;Inherit;False;Constant;_3Row;3 Row;33;0;Create;True;0;0;0;False;0;False;0.015625;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;633;-1384.895,-3752.026;Inherit;False;Property;_CustomColor;Custom Color;32;0;Create;True;0;0;0;False;0;False;0;38;False;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode;325;16.00373,-2092.268;Inherit;True;Property;_PlasterDirtMasksRGBA;PlasterDirtMasksRGBA;18;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;326;-371.3883,-2092.395;Inherit;True;Property;_RGBAMaskA;RGBA Mask A;21;0;Create;True;0;0;0;False;0;False;f6bcb3be2ffc7eb439937251e6b1e988;f6bcb3be2ffc7eb439937251e6b1e988;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.OneMinusNode;467;-1669.907,-2147.911;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;867.0561,1093.596;Float;False;Property;_DamageAmount;Damage Amount;5;0;Create;True;0;0;0;False;0;False;0.6;0.9176471;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;470;-1636.256,-1901.299;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;980.3121,807.3334;Float;False;Property;_DamageAmountSmooth;Damage Amount Smooth;4;0;Create;True;0;0;0;False;0;False;61.17647;14.4;0;17;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;608;-98.76552,-3807.893;Inherit;True;Property;_MainTex;Color Theme;1;0;Create;False;0;0;0;False;0;False;bf84d265e341525459ab1fd8a003c547;bf84d265e341525459ab1fd8a003c547;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;618;387.3604,-3660.392;Inherit;True;Property;_TextureSample0;Texture Sample 0;26;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;469;-1349.85,-2164.142;Inherit;False;2;0;FLOAT;0.1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;610;-708.1978,-3979.334;Half;False;Constant;_Vector1;Vector 1;19;0;Create;True;0;0;0;False;1;;False;0.015625,0;0.125,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.HeightMapBlendNode;58;1428.719,760.1623;Inherit;False;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;635;-1100.895,-3764.026;Inherit;False;Property;_UseCustomColor;Use Custom Color;31;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;614;375.3826,-3858.775;Inherit;True;Property;_TextureSample2;Texture Sample 2;25;0;Create;True;0;0;0;False;0;False;-1;None;None;True;2;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;190;2361.993,-1509.822;Inherit;False;Property;_DirtSmooth;Dirt Smooth;26;0;Create;True;0;0;0;False;1;MaxGay;False;0;0.6242941;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;204;1946.457,1067.808;Inherit;False;Property;_TransitionAmount;Transition Amount;20;0;Create;True;0;0;0;False;0;False;0;0.002035487;0;0.05;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;388;-781.1663,366.371;Inherit;False;Property;_ConcreteDamageTiling;Concrete Damage Tiling;8;0;Create;True;0;0;0;False;0;False;0;2;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;192;2355.597,-1586.802;Inherit;False;Property;_DirtRange;Dirt Range;25;0;Create;True;0;0;0;False;0;False;0;0.5948824;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;621;-1358.73,-3868.998;Inherit;False;Property;_ColorSelect;ColorSelect;0;1;[PerRendererData];Create;True;0;0;0;True;0;False;0;2;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;438;-681.5153,-2483.459;Inherit;False;Property;_PaintEdgesMultiply;Paint Edges Multiply;11;0;Create;True;0;0;0;False;0;False;1;0.4832942;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;642;-400.785,-2740.774;Inherit;False;Property;_BareBrightness;Bare Brightness;33;0;Create;True;0;0;0;False;0;False;0;0.9882354;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;660;3252.827,-361.9397;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;229;518.7689,-1989.24;Inherit;False;Property;_DirtOverlay;Dirt Overlay;16;0;Create;True;0;0;0;False;0;False;0;0.358;0.02;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;237;93.86633,-2242.06;Inherit;False;Property;_EdgesOverlay;Edges Overlay;15;0;Create;True;0;0;0;False;0;False;0;0.408;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;626;383.7579,-3447.177;Inherit;True;Property;_TextureSample4;Texture Sample 4;26;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;463;1381.912,-2626.238;Inherit;False;Property;_DamageBrightness;Damage Brightness;6;0;Create;True;0;0;0;False;0;False;0;1.959415;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;584;1504.524,-2786.599;Inherit;False;Property;_TransitionBrightness;Transition Brightness;18;0;Create;True;0;0;0;False;0;False;0;1.447059;0.5;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;549;-785.2884,-447.7238;Inherit;False;465;PaintEdges;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;552;-820.3799,-337.2308;Inherit;False;Property;_BareSmoothness;Bare Smoothness;30;0;Create;True;0;0;0;False;0;False;0;0.6447374;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;362;-528.7033,-807.2021;Inherit;False;Property;_MainSmoothness;Main Smoothness;27;0;Create;True;0;0;0;False;0;False;0;0.426;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-749.4629,-591.7435;Inherit;False;Property;_DirtSmoothness;Dirt Smoothness;28;0;Create;True;0;0;0;False;0;False;0;1.071279;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;69;347.6044,96.60011;Inherit;True;Property;_DamageNM;Damage NM;2;0;Create;True;0;0;0;False;0;False;-1;381eef27937e5464e93f48a9a73d286d;381eef27937e5464e93f48a9a73d286d;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;384;-789.8114,187.6435;Inherit;False;Property;_TransitionScale;Transition Scale;19;0;Create;True;0;0;0;False;0;False;0;2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;600;3772.426,-2625.251;Inherit;False;599;DamageAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;390;-43.17294,345.2984;Inherit;False;Property;_ConcreteDamageScale;Concrete Damage Scale;9;0;Create;True;0;0;0;False;0;False;0;1.297345;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-464.3829,-78.50299;Inherit;True;Property;_ConcreteNM;Concrete NM;10;0;Create;True;0;0;0;False;0;False;-1;e2f2024fc17d02a4cae64316bfc62502;e2f2024fc17d02a4cae64316bfc62502;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-474.2265,120.6707;Inherit;True;Property;_TransitionNM;Transition NM;17;0;Create;True;0;0;0;False;0;False;-1;4ea5083d09e1aa747b5ad9a32ad2cb74;4ea5083d09e1aa747b5ad9a32ad2cb74;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;357;-103.8612,-495.7261;Inherit;False;Property;_DamageSmoothness;Damage Smoothness;29;0;Create;True;0;0;0;False;0;False;0;0.515;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;345;418.8734,-2877.006;Inherit;True;Property;_DamageColor;Damage Color;3;0;Create;True;0;0;0;False;0;False;3920578cb267cd947bed7ce40996407b;3920578cb267cd947bed7ce40996407b;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;297;3185.221,-1576.04;Inherit;False;Property;_DirtContrast;Dirt Contrast;24;0;Create;True;0;0;0;False;0;False;0;1.036299;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;560;-694.3607,-2877.616;Inherit;False;Property;_ConcreteBare;Concrete Bare;12;0;Create;True;0;0;0;False;0;False;0.9339623,0.8198519,0.2687344,0;0.874,0.8665618,0.825651,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;324;2974.271,-382.311;Inherit;False;323;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;659;3067.827,-652.9397;Inherit;False;Property;_Color;Color;34;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;194;2643.268,-2150.049;Inherit;False;Property;_DirtColor;Dirt Color;23;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.545,0.5013297,0.432185,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;647;0;660;0
WireConnection;647;1;321;0
WireConnection;647;7;352;0
ASEEND*/
//CHKSM=A6C11DFD399C6881DAB756726329BCC07E52377D