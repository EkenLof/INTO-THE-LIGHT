	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_TrimColor = packedInput.ase_texcoord5.xy * _TrimColor_ST.xy + _TrimColor_ST.zw;
				...
				float2 texCoord339 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult337;
				...
				float2 texCoord340 = packedInput.ase_texcoord5.xy * _ColorsNumber + temp_output_336_0;
				...
				float HeightMask8 = saturate(pow(((tex2DNode219.r*( ( pow( tex2DNode219.g , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) ))*4)+(( ( pow( tex2DNode219.g , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) )*2),_DamageSmooth));
				...
				float2 texCoord347 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult346;
				...
				float2 uv_TrimNM = packedInput.ase_texcoord5.xy * _TrimNM_ST.xy + _TrimNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _TrimNM, uv_TrimNM ), _TrimNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_TrimNMScale) );
				float2 uv_TrimDamageNM = packedInput.ase_texcoord5.xy * _TrimDamageNM_ST.xy + _TrimDamageNM_ST.zw;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_TrimColor = packedInput.ase_texcoord2.xy * _TrimColor_ST.xy + _TrimColor_ST.zw;
				float4 tex2DNode150 = tex2D( _TrimColor, uv_TrimColor );
				half2 _ColorsNumber = half2(0,-0.1);
				#ifdef _USECUSTOMCOLOR_ON
				float staticSwitch350 = (float)_CustomColor;
				...
				float2 temp_output_336_0 = ( half2( 0.015625,0 ) * staticSwitch350 );
				float2 appendResult337 = (float2(temp_output_336_0.x , 0.5));
				float2 texCoord339 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult337;
				float4 Color2UV3325 = tex2D( _MainTex, texCoord339 );
				...
				float3 CutoutEdges296 = desaturateVar295;
				float4 lerpResult288 = lerp( tex2DNode150 , Color2UV3325 , float4( ( ( 1.0 - saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _TransitionAmount ) / max( 1.0 , 1E-05 ) ) ) ) ) + CutoutEdges296 ) , 0.0 ));
				float2 texCoord340 = packedInput.ase_texcoord2.xy * _ColorsNumber + temp_output_336_0;
				float4 Color1UV3327 = tex2D( _MainTex, texCoord340 );
				float4 lerpResult147 = lerp( Color1UV3327 , tex2DNode150 , pow( tex2DNode150.a , _MaskOverlay ));
				float HeightMask8 = saturate(pow(((tex2DNode219.r*( ( pow( tex2DNode219.g , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) ))*4)+(( ( pow( tex2DNode219.g , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) )*2),_DamageSmooth));
				float DamageSelection212 = ( 1.0 - HeightMask8 );
				float4 lerpResult149 = lerp( lerpResult288 , lerpResult147 , ( 1.0 - DamageSelection212 ));
				float2 appendResult346 = (float2(temp_output_336_0.x , 0.1));
				float2 texCoord347 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult346;
				float4 DirtColorUV3329 = tex2D( _MainTex, texCoord347 );
				float MaskAlphaChannel227 = tex2DNode219.a;
				float MaskBlueChannel221 = tex2DNode219.b;
				float3 temp_cast_8 = (MaskBlueChannel221).xxx;
				...
				float2 uv_TrimNM = packedInput.ase_texcoord2.xy * _TrimNM_ST.xy + _TrimNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _TrimNM, uv_TrimNM ), _TrimNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_TrimNMScale) );
				float2 uv_TrimDamageNM = packedInput.ase_texcoord2.xy * _TrimDamageNM_ST.xy + _TrimDamageNM_ST.zw;
				float3 unpack2 = UnpackNormalScale( tex2D( _TrimDamageNM, uv_TrimDamageNM ), _TrimDamageNMScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_TrimDamageNMScale) );
				float3 lerpResult17 = lerp( unpack4 , unpack2 , DamageSelection212);
				float3 Normals208 = lerpResult17;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv4_RGBAMaskB = packedInput.ase_texcoord1.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode271 = tex2D( _RGBAMaskB, uv4_RGBAMaskB );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_TrimNM = packedInput.ase_texcoord3.xy * _TrimNM_ST.xy + _TrimNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _TrimNM, uv_TrimNM ), _TrimNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_TrimNMScale) );
				float2 uv_TrimDamageNM = packedInput.ase_texcoord3.xy * _TrimDamageNM_ST.xy + _TrimDamageNM_ST.zw;
				float3 unpack2 = UnpackNormalScale( tex2D( _TrimDamageNM, uv_TrimDamageNM ), _TrimDamageNMScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_TrimDamageNMScale) );
				...
				float temp_output_190_0 = ( ( MaskAlphaChannel227 * saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_1 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) ) ) * _DirtContrast );
				float DirtSelection248 = temp_output_190_0;
				float Smoothness260 = ( pow( tex2DNode306.r , _MainSmoothness ) * ( 1.0 - ( MaskBlueChannel221 * _SmoothnessOverlay ) ) * ( 1.0 - ( _SmoothnessDirt * DirtSelection248 ) ) * ( 1.0 - ( _SmoothnessDamage * DamageSelection212 ) ) );
				
				float2 uv4_RGBAMaskB = packedInput.ase_texcoord3.zw * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode271 = tex2D( _RGBAMaskB, uv4_RGBAMaskB );
				float OpacityMask303 = ( tex2DNode271.g * tex2DNode306.b );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_TrimColor = packedInput.ase_texcoord7.xy * _TrimColor_ST.xy + _TrimColor_ST.zw;
				float4 tex2DNode150 = tex2D( _TrimColor, uv_TrimColor );
				half2 _ColorsNumber = half2(0,-0.1);
				#ifdef _USECUSTOMCOLOR_ON
				float staticSwitch350 = (float)_CustomColor;
				...
				float2 temp_output_336_0 = ( half2( 0.015625,0 ) * staticSwitch350 );
				float2 appendResult337 = (float2(temp_output_336_0.x , 0.5));
				float2 texCoord339 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult337;
				float4 Color2UV3325 = tex2D( _MainTex, texCoord339 );
				...
				float3 CutoutEdges296 = desaturateVar295;
				float4 lerpResult288 = lerp( tex2DNode150 , Color2UV3325 , float4( ( ( 1.0 - saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _TransitionAmount ) / max( 1.0 , 1E-05 ) ) ) ) ) + CutoutEdges296 ) , 0.0 ));
				float2 texCoord340 = packedInput.ase_texcoord7.xy * _ColorsNumber + temp_output_336_0;
				float4 Color1UV3327 = tex2D( _MainTex, texCoord340 );
				float4 lerpResult147 = lerp( Color1UV3327 , tex2DNode150 , pow( tex2DNode150.a , _MaskOverlay ));
				float HeightMask8 = saturate(pow(((tex2DNode219.r*( ( pow( tex2DNode219.g , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) ))*4)+(( ( pow( tex2DNode219.g , _DamagePower ) * ( ( 1.0 - packedInput.ase_color.g ) + ( 1.0 - _DamageMultiply ) ) ) * ( 1.0 - _DamageAmount ) )*2),_DamageSmooth));
				float DamageSelection212 = ( 1.0 - HeightMask8 );
				float4 lerpResult149 = lerp( lerpResult288 , lerpResult147 , ( 1.0 - DamageSelection212 ));
				float2 appendResult346 = (float2(temp_output_336_0.x , 0.1));
				float2 texCoord347 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult346;
				float4 DirtColorUV3329 = tex2D( _MainTex, texCoord347 );
				float MaskAlphaChannel227 = tex2DNode219.a;
				float MaskBlueChannel221 = tex2DNode219.b;
				float3 temp_cast_8 = (MaskBlueChannel221).xxx;
				...
				float2 uv_TrimNM = packedInput.ase_texcoord7.xy * _TrimNM_ST.xy + _TrimNM_ST.zw;
				float3 unpack4 = UnpackNormalScale( tex2D( _TrimNM, uv_TrimNM ), _TrimNMScale );
				unpack4.z = lerp( 1, unpack4.z, saturate(_TrimNMScale) );
				float2 uv_TrimDamageNM = packedInput.ase_texcoord7.xy * _TrimDamageNM_ST.xy + _TrimDamageNM_ST.zw;
				float3 unpack2 = UnpackNormalScale( tex2D( _TrimDamageNM, uv_TrimDamageNM ), _TrimDamageNMScale );
				unpack2.z = lerp( 1, unpack2.z, saturate(_TrimDamageNMScale) );
				float3 lerpResult17 = lerp( unpack4 , unpack2 , DamageSelection212);
				float3 Normals208 = lerpResult17;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-4118.381;718.5472;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;366;4848.381,-205.5472;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;365;4706.381,-526.5472;Inherit;False;Property;_Color;Color;28;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;352;0;366;0
WireConnection;352;1;209;0
WireConnection;352;7;261;0
WireConnection;352;9;304;0
WireConnection;352;10;363;0
ASEEND*/
//CHKSM=60293D70745E2C6120054FC19D2688630F526E55