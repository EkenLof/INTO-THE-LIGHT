...
Shader "DBK HDRP/CinderblockRubble"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_ColorTheme("Color Theme", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 Color383 = tex2D( _ColorTheme, texCoord80 );
				...
				float4 Color1UV381 = tex2D( _ColorTheme, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord5.xy * temp_cast_3 + float2( 0,0 );
				...
				float4 Color2UV386 = tex2D( _ColorTheme, texCoord85 );
				...
				float2 uv_BakedNM = packedInput.ase_texcoord5.xy * _BakedNM_ST.xy + _BakedNM_ST.zw;
				...
				float3 Normals94 = BlendNormal( UnpackNormalScale( tex2D( _BakedNM, uv_BakedNM ), 1.0f ) , unpack21 );
				...
				surfaceDescription.Alpha = Mask_A_Alpha136;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 Color1UV381 = tex2D( _ColorTheme, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord2.xy * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float2 uv_BakedNM = packedInput.ase_texcoord2.xy * _BakedNM_ST.xy + _BakedNM_ST.zw;
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
				unpack21.z = lerp( 1, unpack21.z, saturate(_DetailsNMScale) );
				float3 Normals94 = BlendNormal( UnpackNormalScale( tex2D( _BakedNM, uv_BakedNM ), 1.0f ) , unpack21 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BakedNM = packedInput.ase_texcoord3.xy * _BakedNM_ST.xy + _BakedNM_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float4 Color1UV381 = tex2D( _ColorTheme, texCoord77 );
				float2 temp_cast_3 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord7.xy * temp_cast_3 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float2 uv_BakedNM = packedInput.ase_texcoord7.xy * _BakedNM_ST.xy + _BakedNM_ST.zw;
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
				unpack21.z = lerp( 1, unpack21.z, saturate(_DetailsNMScale) );
				float3 Normals94 = BlendNormal( UnpackNormalScale( tex2D( _BakedNM, uv_BakedNM ), 1.0f ) , unpack21 );
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-949.5054;147.0389;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-715.7373,1978.195;Inherit;False;Property;_PaintSmooth;Paint Smooth;2;0;Create;True;0;0;0;False;0;False;0;0.1941177;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;-2248.326,892.4756;Inherit;False;Property;_DetailsTiling;Details Tiling;8;0;Create;True;0;0;0;False;0;False;0;7;1;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;55;-1689.782,842.0186;Inherit;True;Property;_MaskB;Mask B;16;0;Create;True;0;0;0;False;0;False;-1;5b71a3cf759201643b7d66aa9084dbd4;5b71a3cf759201643b7d66aa9084dbd4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;76;-512.2083,-1111.84;Inherit;True;Property;_ColorTheme;Color Theme;0;0;Create;False;0;0;0;False;0;False;fb0e05ef0dc56c643af47507dafa28c9;fb0e05ef0dc56c643af47507dafa28c9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-735.0119,1904.403;Inherit;False;Property;_PaintRange;Paint Range;1;0;Create;True;0;0;0;False;0;False;0;0.6450222;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;851.2473,1615.999;Inherit;False;Property;_DirtRange;Dirt Range;11;0;Create;True;0;0;0;False;0;False;0;0.496255;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;66;-765.544,50.80575;Inherit;False;86;Color2UV3;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;47;835.2473,1679.999;Inherit;False;Property;_DirtSmooth;Dirt Smooth;10;0;Create;True;0;0;0;False;1;MaxGay;False;0;0.496255;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;1299.247,1631.999;Inherit;False;Property;_DirtContrast;Dirt Contrast;12;0;Create;True;0;0;0;False;0;False;0;0.7572266;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;195;1800.505,301.9612;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;192;1693.045,743.0421;Inherit;False;Property;_AlphaClip;Alpha Clip;20;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;133;-906.0053,829.848;Inherit;True;Property;_MainTex;Mask A;9;0;Create;False;0;0;0;False;0;False;-1;8a7917f1a5346cb4aaeb8219be7944ad;8a7917f1a5346cb4aaeb8219be7944ad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;165;1125.949,-1193.88;Inherit;False;134;Mask_A_Red;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;130;-744.8369,351.7798;Inherit;False;Property;_DirtBrightness;Dirt Brightness;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;1079.862,-1104.907;Inherit;False;Property;_MainSmoothness;Main Smoothness;14;0;Create;True;0;0;0;False;0;False;0;0.1339571;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;1550.841,-863.9733;Inherit;False;Property;_PaintSmoothness;Paint Smoothness;15;0;Create;True;0;0;0;False;0;False;0;0.1812644;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;179;501.2112,91.91891;Inherit;False;Property;_AODirt;AO Dirt;19;0;Create;True;0;0;0;False;0;False;0;0.3411765;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-2424.818,1863.233;Inherit;False;Property;_DetailsNMScale;Details NM Scale;7;0;Create;True;0;0;0;False;0;False;0;0.5748621;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;142;1606.354,583.0516;Inherit;False;136;Mask_A_Alpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;-1798.416,-90.33264;Inherit;False;Property;_CinderblockBrightness;Cinderblock Brightness;3;0;Create;True;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;21;-2085.818,1735.233;Inherit;True;Property;_DetailsNM;Details NM;6;0;Create;True;0;0;0;False;0;False;-1;4ea5083d09e1aa747b5ad9a32ad2cb74;4ea5083d09e1aa747b5ad9a32ad2cb74;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;164;1611.208,485.7929;Inherit;False;163;Smoothnes;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;194;1633.505,26.96118;Inherit;False;Property;_Color;Color;21;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;5;-2101.818,1498.233;Inherit;True;Property;_BakedNM;Baked NM;5;0;Create;True;0;0;0;False;0;False;-1;c7342cf42c2aa984795350a5666fedab;c7342cf42c2aa984795350a5666fedab;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;181;0;195;0
WireConnection;181;1;95;0
WireConnection;181;7;164;0
WireConnection;181;9;142;0
WireConnection;181;10;192;0
ASEEND*/
//CHKSM=14EF7C16696C99B50EFA2F62E9B5BCC170B66EEE