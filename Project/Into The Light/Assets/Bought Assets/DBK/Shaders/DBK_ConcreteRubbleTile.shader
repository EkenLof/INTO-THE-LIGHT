...
Shader "DBK HDRP/ConcreteRubbleTile"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord236 = inputMesh.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				...
				float2 texCoord89 = inputMesh.ase_texcoord.xy * temp_cast_2 + float2( 0,0 );
						...
						)
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord236 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling238 = texCoord236;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 texCoord77 = packedInput.uv2.xy * _ColorsNumber + temp_output_74_0;
				...
				float2 texCoord85 = packedInput.uv2.xy * _ColorsNumber + appendResult87;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord236 = inputMesh.uv0.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling238 = texCoord236;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( Tiling238, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = inputMesh.ase_color.b;
				float3 temp_cast_1 = (VertexBlue194).xxx;
				float2 temp_cast_2 = (_DetailsTiling).xx;
				float2 texCoord89 = inputMesh.uv0.xy * temp_cast_2 + float2( 0,0 );
				float4 tex2DNode55 = tex2Dlod( _MaskB, float4( texCoord89, 0, 0.0) );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_3 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_1 , temp_cast_3 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.zw = inputMesh.uv2.xy;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord236 = packedInput.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling238 = texCoord236;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord2.xy * temp_cast_1 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float4 tex2DNode133 = tex2D( _MainTex1, Tiling238 );
				float Mask_A_Blue135 = tex2DNode133.b;
				...
				#endif
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 texCoord77 = packedInput.ase_texcoord2.zw * _ColorsNumber + temp_output_74_0;
				float4 UV_PaintColor81 = tex2D( _MainTex, texCoord77 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_4 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
				...
				float4 lerpResult126 = lerp( ( ( tex2D( _ColorMap, Tiling238 ) * Mask_B_Alpha59 ) + ( ( 1.0 - Mask_A_Blue135 ) * _ConcreteBrightness ) ) , UV_PaintColor81 , PaintSelection119);
				float2 appendResult87 = (float2(temp_output_74_0.x , -0.45));
				float2 texCoord85 = packedInput.ase_texcoord2.zw * _ColorsNumber + appendResult87;
				float4 UV_DirtColor86 = tex2D( _MainTex, texCoord85 );
				float VertexRed62 = packedInput.ase_color.r;
				float3 temp_cast_7 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
				float3 temp_cast_8 = (( 1.0 - Mask_B_Red56 )).xxx;
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord236 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling238 = texCoord236;
				float3 unpack217 = UnpackNormalScale( tex2D( _BakedNM, Tiling238 ), _BakedNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BakedNMScale) );
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 TilingAmount91 = texCoord89;
				float3 unpack21 = UnpackNormalScale( tex2D( _DetailsNM, TilingAmount91 ), _DetailsNMScale );
				unpack21.z = lerp( 1, unpack21.z, saturate(_DetailsNMScale) );
				float3 Normals94 = BlendNormal( unpack217 , unpack21 );
				...
				float Mask_B_Green57 = tex2DNode55.g;
				float VertexGreen63 = packedInput.ase_color.g;
				float3 temp_cast_3 = (( Mask_B_Green57 * VertexGreen63 )).xxx;
				float Mask_A_Blue135 = tex2DNode133.b;
				float PaintSelection119 = ( saturate( ( 1.0 - ( ( distance( temp_cast_2 , temp_cast_3 ) - _PaintRange ) / max( _PaintSmooth , 1E-05 ) ) ) ) * ( 1.0 - Mask_A_Blue135 ) );
				float VertexRed62 = packedInput.ase_color.r;
				float Mask_B_Alpha59 = tex2DNode55.a;
				float3 temp_cast_4 = (( VertexRed62 * Mask_B_Alpha59 )).xxx;
				float3 temp_cast_5 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult51 = clamp( ( saturate( ( 1.0 - ( ( distance( temp_cast_4 , temp_cast_5 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) ) * _DirtContrast ) , 0.0 , 1.0 );
				float DirtSelection52 = clampResult51;
				float Smoothnes163 = ( ( ( ( 1.0 - Mask_A_Red134 ) * _MainSmoothness ) + ( _PaintSmoothness * PaintSelection119 ) ) * ( 1.0 - DirtSelection52 ) );
				
				float VertexBlue194 = packedInput.ase_color.b;
				float3 temp_cast_6 = (VertexBlue194).xxx;
				float3 temp_cast_7 = (( 1.0 - Mask_B_Red56 )).xxx;
				float clampResult188 = clamp( saturate( ( 1.0 - ( ( distance( temp_cast_6 , temp_cast_7 ) - _CutAlphaRange ) / max( _CutAlphaSmooth , 1E-05 ) ) ) ) , 0.0 , 1.0 );
				float AlphaSelection189 = clampResult188;
				float temp_output_202_0 = ( 1.0 - AlphaSelection189 );
				float AlphaMap208 = temp_output_202_0;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord236 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling238 = texCoord236;
				float2 temp_cast_1 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Alpha59 = tex2DNode55.a;
				float4 tex2DNode133 = tex2D( _MainTex1, Tiling238 );
				float Mask_A_Blue135 = tex2DNode133.b;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1734.227;310.2704;1;True;False
...
Node;AmplifyShaderEditor.IntNode;70;-1534.617,-1047.546;Inherit;False;Property;_ColorSelect;ColorSelect;8;1;[PerRendererData];Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.ColorNode;256;2533.115,-122.9662;Inherit;False;Property;_Color;Color;26;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;257;2650.115,220.0338;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;257;0;144;0
WireConnection;257;1;256;0
WireConnection;115;0;122;0
WireConnection;243;0;257;0
WireConnection;243;1;95;0
WireConnection;243;7;164;0
WireConnection;243;9;209;0
WireConnection;243;10;254;0
WireConnection;243;11;206;0
ASEEND*/
//CHKSM=09D81F88AE13738996C432B5F769E009A8F5BB62