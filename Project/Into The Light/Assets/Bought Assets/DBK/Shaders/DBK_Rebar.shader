	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 unpack18 = UnpackNormalScale( tex2D( _Normals, uv_Normals ), _NormalsScale );
				unpack18.z = lerp( 1, unpack18.z, saturate(_NormalsScale) );
				...
				surfaceDescription.Normal = unpack18;
				...
				surfaceDescription.Smoothness = tex2D( _Smoothness, uv_Smoothness ).r;
