	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord328 = packedInput.ase_texcoord5.xy * _ColorsNumber + temp_output_324_0;
				...
				float2 texCoord327 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult325;
				...
				float HeightMask10 = saturate(pow(((tex2DNode178.b*( ( ( ( 1.0 - tex2DNode178.g ) * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount ))*4)+(( ( ( ( 1.0 - tex2DNode178.g ) * _DamageMultiplier ) * packedInput.ase_color.g ) * _DamageAmount )*2),_DamageSmooth));
				...
				float2 texCoord333 = packedInput.ase_texcoord5.xy * _ColorsNumber + appendResult331;
				float4 DirtColorUV3311 = tex2D( _MainTex, texCoord333 );
				float2 uv_RGBAMaskC = packedInput.ase_texcoord5.xy * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float3 temp_cast_4 = (( tex2DNode178.r * _DirtMultiplier )).xxx;
				float3 temp_cast_5 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode178.g ) )).xxx;
				...
				float2 uv_NormalGood = packedInput.ase_texcoord5.xy * _NormalGood_ST.xy + _NormalGood_ST.zw;
				...
				float2 uv_NormalDamage = packedInput.ase_texcoord5.xy * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
				...
				float2 uv4_RGBAMaskC = packedInput.ase_texcoord5.zw * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				#endif
				float2 temp_output_324_0 = ( half2( 0.015625,0 ) * staticSwitch338 );
				float2 texCoord328 = packedInput.ase_texcoord2.xy * _ColorsNumber + temp_output_324_0;
				float4 Color1UV3309 = tex2D( _MainTex, texCoord328 );
				float2 uv_RGBAMaskB = packedInput.ase_texcoord2.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode268 = tex2D( _RGBAMaskB, uv_RGBAMaskB );
				float4 temp_output_33_0 = ( Color1UV3309 * ( 1.0 - ( ( 1.0 - tex2DNode268.r ) * _DirtOverlay ) ) );
				float2 appendResult325 = (float2(temp_output_324_0.x , 0.5));
				float2 texCoord327 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult325;
				float4 Color2UV3307 = tex2D( _MainTex, texCoord327 );
				...
				float4 lerpResult14 = lerp( ( temp_output_33_0 + ( ( tex2DNode268.g * _EdgesOverlay ) * temp_output_33_0 ) ) , ( ( Color2UV3307 * pow( tex2DNode268.b , _DirtDamageOverlay ) ) + ( ( ( tex2DNode268.a + ( BricksStep262 * _EdgeBrighntess ) ) * _EdgesDamageOverlay ) * Color2UV3307 ) ) , clampResult314);
				float2 appendResult331 = (float2(temp_output_324_0.x , 0.1));
				float2 texCoord333 = packedInput.ase_texcoord2.xy * _ColorsNumber + appendResult331;
				float4 DirtColorUV3311 = tex2D( _MainTex, texCoord333 );
				float2 uv_RGBAMaskC = packedInput.ase_texcoord2.xy * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float3 temp_cast_4 = (( tex2DNode178.r * _DirtMultiplier )).xxx;
				float3 temp_cast_5 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode178.g ) )).xxx;
				float DirtHeight74 = saturate( ( 1.0 - ( ( distance( temp_cast_4 , temp_cast_5 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
				float4 lerpResult30 = lerp( lerpResult14 , ( DirtColorUV3311 * tex2D( _RGBAMaskC, uv_RGBAMaskC ).r ) , ( DirtHeight74 * _DirtOpacity ));
				...
				float2 uv_NormalGood = packedInput.ase_texcoord2.xy * _NormalGood_ST.xy + _NormalGood_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _NormalGood, uv_NormalGood ), _NormalGoodScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalGoodScale) );
				float2 uv_NormalDamage = packedInput.ase_texcoord2.xy * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _NormalDamage, uv_NormalDamage ), _NormalDamageScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_NormalDamageScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , Heightmap11);
				float3 Normals92 = lerpResult21;
				...
				float2 uv4_RGBAMaskC = packedInput.ase_texcoord2.zw * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float OpacityMask276 = tex2D( _RGBAMaskC, uv4_RGBAMaskC ).g;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv4_RGBAMaskC = packedInput.ase_texcoord1.xy * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float OpacityMask276 = tex2D( _RGBAMaskC, uv4_RGBAMaskC ).g;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_NormalGood = packedInput.ase_texcoord3.xy * _NormalGood_ST.xy + _NormalGood_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _NormalGood, uv_NormalGood ), _NormalGoodScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalGoodScale) );
				float2 uv_NormalDamage = packedInput.ase_texcoord3.xy * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _NormalDamage, uv_NormalDamage ), _NormalDamageScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_NormalDamageScale) );
				...
				float GreenChannelRGBA123 = tex2DNode178.r;
				float RedChannelRGBA109 = tex2DNode178.g;
				float3 temp_cast_0 = (( tex2DNode178.r * _DirtMultiplier )).xxx;
				float3 temp_cast_1 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode178.g ) )).xxx;
				float DirtHeight74 = saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_1 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
				float Smoothness117 = ( ( _SmoothnessMain * ( 1.0 - ( GreenChannelRGBA123 * _SmoothnessMainDirt ) ) * RedChannelRGBA109 ) * ( 1.0 - ( _SmoothnessDamage * Heightmap11 ) ) * ( 1.0 - ( _SmoothnessDirt * DirtHeight74 ) ) );
				
				float2 uv4_RGBAMaskC = packedInput.ase_texcoord3.zw * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float OpacityMask276 = tex2D( _RGBAMaskC, uv4_RGBAMaskC ).g;
		...
		Pass
		{
						...
						)
			{
				...
				#endif
				float2 temp_output_324_0 = ( half2( 0.015625,0 ) * staticSwitch338 );
				float2 texCoord328 = packedInput.ase_texcoord7.xy * _ColorsNumber + temp_output_324_0;
				float4 Color1UV3309 = tex2D( _MainTex, texCoord328 );
				float2 uv_RGBAMaskB = packedInput.ase_texcoord7.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode268 = tex2D( _RGBAMaskB, uv_RGBAMaskB );
				float4 temp_output_33_0 = ( Color1UV3309 * ( 1.0 - ( ( 1.0 - tex2DNode268.r ) * _DirtOverlay ) ) );
				float2 appendResult325 = (float2(temp_output_324_0.x , 0.5));
				float2 texCoord327 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult325;
				float4 Color2UV3307 = tex2D( _MainTex, texCoord327 );
				...
				float4 lerpResult14 = lerp( ( temp_output_33_0 + ( ( tex2DNode268.g * _EdgesOverlay ) * temp_output_33_0 ) ) , ( ( Color2UV3307 * pow( tex2DNode268.b , _DirtDamageOverlay ) ) + ( ( ( tex2DNode268.a + ( BricksStep262 * _EdgeBrighntess ) ) * _EdgesDamageOverlay ) * Color2UV3307 ) ) , clampResult314);
				float2 appendResult331 = (float2(temp_output_324_0.x , 0.1));
				float2 texCoord333 = packedInput.ase_texcoord7.xy * _ColorsNumber + appendResult331;
				float4 DirtColorUV3311 = tex2D( _MainTex, texCoord333 );
				float2 uv_RGBAMaskC = packedInput.ase_texcoord7.xy * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float3 temp_cast_4 = (( tex2DNode178.r * _DirtMultiplier )).xxx;
				float3 temp_cast_5 = (( 1.0 - ( packedInput.ase_color.r * tex2DNode178.g ) )).xxx;
				float DirtHeight74 = saturate( ( 1.0 - ( ( distance( temp_cast_4 , temp_cast_5 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) );
				float4 lerpResult30 = lerp( lerpResult14 , ( DirtColorUV3311 * tex2D( _RGBAMaskC, uv_RGBAMaskC ).r ) , ( DirtHeight74 * _DirtOpacity ));
				...
				float2 uv_NormalGood = packedInput.ase_texcoord7.xy * _NormalGood_ST.xy + _NormalGood_ST.zw;
				float3 unpack19 = UnpackNormalScale( tex2D( _NormalGood, uv_NormalGood ), _NormalGoodScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalGoodScale) );
				float2 uv_NormalDamage = packedInput.ase_texcoord7.xy * _NormalDamage_ST.xy + _NormalDamage_ST.zw;
				float3 unpack20 = UnpackNormalScale( tex2D( _NormalDamage, uv_NormalDamage ), _NormalDamageScale );
				unpack20.z = lerp( 1, unpack20.z, saturate(_NormalDamageScale) );
				float3 lerpResult21 = lerp( unpack19 , unpack20 , Heightmap11);
				float3 Normals92 = lerpResult21;
				...
				float2 uv4_RGBAMaskC = packedInput.ase_texcoord7.zw * _RGBAMaskC_ST.xy + _RGBAMaskC_ST.zw;
				float OpacityMask276 = tex2D( _RGBAMaskC, uv4_RGBAMaskC ).g;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1505.789;-373.847;1;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;104;2204.572,993.936;Inherit;False;103;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;354;2392.789,1003.847;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;339;0;354;0
WireConnection;339;1;93;0
WireConnection;339;7;118;0
WireConnection;339;9;277;0
WireConnection;339;10;351;0
ASEEND*/
//CHKSM=B238C44ACF97B273775CE4BE9DA8618278F30B17