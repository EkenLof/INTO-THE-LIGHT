...
Shader "DBK HDRP/BrickRubbleTile"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_MainTex("Color Theme", 2D) = "white" {}
		...
		_DetailsTiling("Details Tiling", Range( 1 , 8)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord218 = inputMesh.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
						...
						)
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				...
				float2 texCoord80 = packedInput.uv2.xy * _ColorsNumber + appendResult79;
				...
				float2 temp_cast_5 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord5.xy * temp_cast_5 + float2( 0,0 );
				...
				float3 unpack217 = UnpackNormalScale( tex2D( _BakedNM, Tiling220 ), _BakedNMScale );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = inputMesh.uv0.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2Dlod( _MainTex1, float4( Tiling220, 0, 0.0) );
				float Mask_A_Alpha136 = tex2DNode133.a;
				float VertexBlue194 = inputMesh.ase_color.b;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = packedInput.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2D( _MainTex1, Tiling220 );
				float Mask_A_Red134 = tex2DNode133.r;
				float4 temp_cast_1 = (Mask_A_Red134).xxxx;
				...
				float2 temp_output_74_0 = ( half2( 0.015625,0 ) * staticSwitch72 );
				float2 appendResult79 = (float2(temp_output_74_0.x , -0.86));
				float2 texCoord80 = packedInput.ase_texcoord2.zw * _ColorsNumber + appendResult79;
				float4 Color383 = tex2D( _MainTex, texCoord80 );
				float2 texCoord77 = packedInput.ase_texcoord2.zw * _ColorsNumber + temp_output_74_0;
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_5 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord2.xy * temp_cast_5 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_6 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float3 unpack217 = UnpackNormalScale( tex2D( _BakedNM, Tiling220 ), _BakedNMScale );
				unpack217.z = lerp( 1, unpack217.z, saturate(_BakedNMScale) );
				float2 temp_cast_1 = (_DetailsTiling).xx;
				...
				float Mask_A_Green137 = tex2DNode133.g;
				float PaintSelection119 = ( saturate( ( 1.0 - ( ( distance( temp_cast_2 , temp_cast_3 ) - _PaintRange ) / max( _PaintSmooth , 1E-05 ) ) ) ) * Mask_A_Green137 );
				float VertexRed62 = packedInput.ase_color.r;
				float Mask_B_Alpha59 = tex2DNode55.a;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_MainTiling).xx;
				float2 texCoord218 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling220 = texCoord218;
				float4 tex2DNode133 = tex2D( _MainTex1, Tiling220 );
				float Mask_A_Red134 = tex2DNode133.r;
				float4 temp_cast_1 = (Mask_A_Red134).xxxx;
				...
				float4 Color1UV381 = tex2D( _MainTex, texCoord77 );
				float2 temp_cast_5 = (_DetailsTiling).xx;
				float2 texCoord89 = packedInput.ase_texcoord7.xy * temp_cast_5 + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MaskB, texCoord89 );
				float Mask_B_Red56 = tex2DNode55.r;
				float3 temp_cast_6 = (( 1.0 - Mask_B_Red56 )).xxx;
				float Mask_B_Green57 = tex2DNode55.g;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1701.441;116.0301;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;234;-984.9158,2213.489;Inherit;False;878;206;Comment;3;219;218;220;UV Tiling;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;55;-1689.782,842.0186;Inherit;True;Property;_MaskB;Mask B;11;0;Create;True;0;0;0;False;0;False;-1;5b71a3cf759201643b7d66aa9084dbd4;5b71a3cf759201643b7d66aa9084dbd4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;71;-1533.295,-906.8967;Inherit;False;Property;_CustomColor;Custom Color;19;0;Create;True;0;0;0;False;0;False;0;10;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;-2248.326,892.4756;Inherit;False;Property;_DetailsTiling;Details Tiling;7;0;Create;True;0;0;0;False;0;False;1;5;1;8;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;219;-934.9158,2269.489;Inherit;False;Property;_MainTiling;Main Tiling;1;0;Create;True;0;0;0;False;0;False;1;1;0.1;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;72;-1313.295,-942.8968;Inherit;False;Property;_UseCustomColor;Use Custom Color;18;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;183;827.8595,2592.128;Inherit;False;Property;_CutAlphaRange;Cut Alpha Range;21;0;Create;True;0;0;0;False;0;False;0;0.07344181;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;76;-512.2083,-1112.84;Inherit;True;Property;_MainTex;Color Theme;0;0;Create;False;0;0;0;False;0;False;a4b54f4a931b12047a9252ab1e0b62a0;a4b54f4a931b12047a9252ab1e0b62a0;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;46;2277.391,1679.693;Inherit;False;Property;_DirtRange;Dirt Range;13;0;Create;True;0;0;0;False;0;False;0;0.213007;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;2261.39,1743.693;Inherit;False;Property;_DirtSmooth;Dirt Smooth;12;0;Create;True;0;0;0;False;1;MaxGay;False;0;0.8348978;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;2725.391,1695.693;Inherit;False;Property;_DirtContrast;Dirt Contrast;14;0;Create;True;0;0;0;False;0;False;0;1.010981;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;182;855.859,2689.127;Inherit;False;Property;_CutAlphaSmooth;Cut Alpha Smooth;20;0;Create;True;0;0;0;False;1;MaxGay;False;0;1.423529;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;236;2449.441,-34.03015;Inherit;False;Property;_Color;Color;23;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;167;1941.254,-747.2681;Inherit;False;52;DirtSelection;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;215;-2466.783,1618.812;Inherit;False;Property;_BakedNMScale;Baked NM Scale;9;0;Create;True;0;0;0;False;0;False;1;1.642817;1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;1079.862,-1104.907;Inherit;False;Property;_MainSmoothness;Main Smoothness;16;0;Create;True;0;0;0;False;0;False;0;0.1068977;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;1550.841,-863.9733;Inherit;False;Property;_PaintSmoothness;Paint Smoothness;17;0;Create;True;0;0;0;False;0;False;0;0.1573163;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-113.1507,340.9817;Inherit;False;Property;_DirtBrightness;Dirt Brightness;15;0;Create;True;0;0;0;False;0;False;0;0.591684;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;144;2481.374,187.4877;Inherit;False;143;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;209;2490.544,512.0228;Inherit;False;208;AlphaMap;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;1074.518,1906.409;Float;False;Property;_Displacement;Displacement;22;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;217;-2152.783,1484.812;Inherit;True;Property;_BakedNM;Baked NM;8;0;Create;True;0;0;0;False;0;False;-1;dc820580967230744910ba914b8a57f2;dc820580967230744910ba914b8a57f2;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;237;2638.441,208.9698;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;223;1;95;0
WireConnection;223;7;164;0
WireConnection;223;9;209;0
WireConnection;223;11;206;0
ASEEND*/
//CHKSM=86A233A7F559B2B7780EBCA11BF4257745A676E1