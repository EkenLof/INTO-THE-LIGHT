	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord666 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + appendResult667;
				...
				float2 texCoord656 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch676 );
				...
				float VertexBlue593 = packedInput.ase_color.b;
				...
				float2 uv_RGBA_Mask_A = packedInput.ase_texcoord5.zw * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				...
				float HeightMask6 = saturate(pow(((BricksDirtBlue598*( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) ))*4)+(( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) )*2),_DamageSmoothness));
				...
				float2 texCoord650 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + appendResult649;
				...
				float VertexAlpha521 = packedInput.ase_color.a;
				...
				float2 texCoord661 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + appendResult660;
				float4 DirtColorUV3663 = tex2D( _MainTex, texCoord661 );
				float3 temp_cast_6 = (tex2DNode371.g).xxx;
				float VertexRed592 = packedInput.ase_color.r;
				...
				float2 uv_TextureSample3 = packedInput.ase_texcoord5.zw * _TextureSample3_ST.xy + _TextureSample3_ST.zw;
				...
				float2 uv_DBK_Brick_NM = packedInput.ase_texcoord5.zw * _DBK_Brick_NM_ST.xy + _DBK_Brick_NM_ST.zw;
				...
				float2 uv_BrickUniqueNM = packedInput.ase_texcoord5.zw * _BrickUniqueNM_ST.xy + _BrickUniqueNM_ST.zw;
				...
				surfaceDescription.Albedo = ( lerpResult372 * _Color ).rgb;
				surfaceDescription.Normal = Normals446;
				...
				surfaceDescription.Smoothness = Smoothness638;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_659_0 = ( staticSwitch676 * 0.015625 );
				float2 appendResult667 = (float2(temp_output_659_0 , -0.75));
				float2 texCoord666 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + appendResult667;
				float4 BricksColorUV3668 = tex2D( _MainTex, texCoord666 );
				...
				float4 lerpResult23 = lerp( BricksColorUV3668 , temp_cast_2 , tex2DNode561.r);
				float4 BricksLerp578 = lerpResult23;
				float2 texCoord656 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch676 );
				float4 PaintColorUV3658 = tex2D( _MainTex, texCoord656 );
				float BricksMask_Blue573 = tex2DNode561.b;
				float3 temp_cast_3 = (( 1.0 - tex2DNode606.b )).xxx;
				float VertexBlue593 = packedInput.ase_color.b;
				...
				float PaintEdges471 = saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _WhiteBrickRange ) / max( _WhiteBrickSmooth , 1E-05 ) ) ) );
				float PaintEdgesSelection476 = step( 0.1 , ( ( 1.0 - PaintEdges471 ) * step( _DarkBrickAmount , PaintEdges471 ) ) );
				float2 uv_RGBA_Mask_A = packedInput.ase_texcoord2.zw * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				float4 tex2DNode371 = tex2D( _RGBA_Mask_A, uv_RGBA_Mask_A );
				float BricksDirtBlue598 = tex2DNode371.b;
				float BricksDirtRed597 = tex2DNode371.r;
				float HeightMask6 = saturate(pow(((BricksDirtBlue598*( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) ))*4)+(( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) )*2),_DamageSmoothness));
				...
				float BricksHeightBlue601 = tex2DNode606.a;
				float2 appendResult649 = (float2(( staticSwitch676 * 0.015625 ) , -0.25));
				float2 texCoord650 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + appendResult649;
				float4 TransitionUV3654 = tex2D( _MainTex, texCoord650 );
				float4 TransitionColor562 = ( BricksHeightBlue601 * TransitionUV3654 );
				float BricksStep406 = (0.0 + (step( 0.1 , ( ( 1.0 - HeightBricks385 ) * step( _TransitionScale , HeightBricks385 ) ) ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0));
				float4 lerpResult124 = lerp( BricksBrightDarkLerp581 , TransitionColor562 , BricksStep406);
				...
				float4 lerpResult548 = lerp( LerpTransition584 , UniqueBricksLerp547 , VertexAlpha521);
				float2 appendResult660 = (float2(temp_output_659_0 , -0.5));
				float2 texCoord661 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + appendResult660;
				float4 DirtColorUV3663 = tex2D( _MainTex, texCoord661 );
				float3 temp_cast_6 = (tex2DNode371.g).xxx;
				float VertexRed592 = packedInput.ase_color.r;
				float3 temp_cast_7 = (( 1.0 - VertexRed592 )).xxx;
				...
				float2 uv_TextureSample3 = packedInput.ase_texcoord2.zw * _TextureSample3_ST.xy + _TextureSample3_ST.zw;
				float3 unpack15 = UnpackNormalScale( tex2D( _TextureSample3, uv_TextureSample3 ), _BrickScale );
				unpack15.z = lerp( 1, unpack15.z, saturate(_BrickScale) );
				float2 uv_DBK_Brick_NM = packedInput.ase_texcoord2.zw * _DBK_Brick_NM_ST.xy + _DBK_Brick_NM_ST.zw;
				float3 unpack691 = UnpackNormalScale( tex2D( _DBK_Brick_NM, uv_DBK_Brick_NM ), _PaintedBrickScale );
				unpack691.z = lerp( 1, unpack691.z, saturate(_PaintedBrickScale) );
				float3 lerpResult689 = lerp( unpack15 , unpack691 , HeightBricks385);
				float2 uv_BrickUniqueNM = packedInput.ase_texcoord2.zw * _BrickUniqueNM_ST.xy + _BrickUniqueNM_ST.zw;
				float3 unpack517 = UnpackNormalScale( tex2D( _BrickUniqueNM, uv_BrickUniqueNM ), _BrickUniqueScale );
				unpack517.z = lerp( 1, unpack517.z, saturate(_BrickUniqueScale) );
				float3 lerpResult520 = lerp( lerpResult689 , unpack517 , VertexAlpha521);
				float3 Normals446 = lerpResult520;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_TextureSample3 = packedInput.ase_texcoord3.xy * _TextureSample3_ST.xy + _TextureSample3_ST.zw;
				float3 unpack15 = UnpackNormalScale( tex2D( _TextureSample3, uv_TextureSample3 ), _BrickScale );
				unpack15.z = lerp( 1, unpack15.z, saturate(_BrickScale) );
				float2 uv_DBK_Brick_NM = packedInput.ase_texcoord3.xy * _DBK_Brick_NM_ST.xy + _DBK_Brick_NM_ST.zw;
				float3 unpack691 = UnpackNormalScale( tex2D( _DBK_Brick_NM, uv_DBK_Brick_NM ), _PaintedBrickScale );
				unpack691.z = lerp( 1, unpack691.z, saturate(_PaintedBrickScale) );
				float2 uv_RGBA_Mask_A = packedInput.ase_texcoord3.xy * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				float4 tex2DNode371 = tex2D( _RGBA_Mask_A, uv_RGBA_Mask_A );
				float BricksDirtBlue598 = tex2DNode371.b;
				float BricksDirtRed597 = tex2DNode371.r;
				float HeightMask6 = saturate(pow(((BricksDirtBlue598*( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) ))*4)+(( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) )*2),_DamageSmoothness));
				float HeightBricks385 = HeightMask6;
				float3 lerpResult689 = lerp( unpack15 , unpack691 , HeightBricks385);
				float2 uv_BrickUniqueNM = packedInput.ase_texcoord3.xy * _BrickUniqueNM_ST.xy + _BrickUniqueNM_ST.zw;
				float3 unpack517 = UnpackNormalScale( tex2D( _BrickUniqueNM, uv_BrickUniqueNM ), _BrickUniqueScale );
				unpack517.z = lerp( 1, unpack517.z, saturate(_BrickUniqueScale) );
				float VertexAlpha521 = packedInput.ase_color.a;
				float3 lerpResult520 = lerp( lerpResult689 , unpack517 , VertexAlpha521);
				...
				float BricksTileSelection609 = tex2DNode606.r;
				float BricksDirt_Alpha614 = tex2DNode371.a;
				float3 temp_cast_0 = (( 1.0 - tex2DNode606.b )).xxx;
				float VertexBlue593 = packedInput.ase_color.b;
				float2 uv_RGBAMaskB = packedInput.ase_texcoord3.xy * _RGBAMaskB_ST.xy + _RGBAMaskB_ST.zw;
				float4 tex2DNode561 = tex2D( _RGBAMaskB, uv_RGBAMaskB );
				float BricksMask_Alpha604 = tex2DNode561.a;
				float3 temp_cast_1 = (( 1.0 - ( ( 1.0 - VertexBlue593 ) * BricksMask_Alpha604 ) )).xxx;
				float PaintEdges471 = saturate( ( 1.0 - ( ( distance( temp_cast_0 , temp_cast_1 ) - _WhiteBrickRange ) / max( _WhiteBrickSmooth , 1E-05 ) ) ) );
				float lerpResult410 = lerp( ( BricksTileSelection609 * _BrickBareSmoothness ) , ( _BrickPaintSmoothness * ( 1.0 - ( BricksDirt_Alpha614 * _BrickDirtSmoothness ) ) * ( 1.0 - ( PaintEdges471 * _BrickDarkSmoothness ) ) ) , HeightBricks385);
				float3 temp_cast_2 = (tex2DNode371.g).xxx;
				float VertexRed592 = packedInput.ase_color.r;
				float3 temp_cast_3 = (( 1.0 - VertexRed592 )).xxx;
				float temp_output_387_0 = ( tex2DNode371.a * saturate( ( 1.0 - ( ( distance( temp_cast_2 , temp_cast_3 ) - _DirtRange ) / max( _DirtSmooth , 1E-05 ) ) ) ) );
				float BricksMainDirt625 = temp_output_387_0;
				float BricksUniqueSelection634 = tex2DNode606.g;
				float lerpResult632 = lerp( ( lerpResult410 * ( 1.0 - ( _BrickDirtMainSmoothness * BricksMainDirt625 ) ) ) , ( _BrickBareSmoothness * BricksUniqueSelection634 ) , VertexAlpha521);
				float Smoothness638 = lerpResult632;
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_659_0 = ( staticSwitch676 * 0.015625 );
				float2 appendResult667 = (float2(temp_output_659_0 , -0.75));
				float2 texCoord666 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + appendResult667;
				float4 BricksColorUV3668 = tex2D( _MainTex, texCoord666 );
				...
				float4 lerpResult23 = lerp( BricksColorUV3668 , temp_cast_2 , tex2DNode561.r);
				float4 BricksLerp578 = lerpResult23;
				float2 texCoord656 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + ( half2( 0.015625,0 ) * staticSwitch676 );
				float4 PaintColorUV3658 = tex2D( _MainTex, texCoord656 );
				float BricksMask_Blue573 = tex2DNode561.b;
				float3 temp_cast_3 = (( 1.0 - tex2DNode606.b )).xxx;
				float VertexBlue593 = packedInput.ase_color.b;
				...
				float PaintEdges471 = saturate( ( 1.0 - ( ( distance( temp_cast_3 , temp_cast_4 ) - _WhiteBrickRange ) / max( _WhiteBrickSmooth , 1E-05 ) ) ) );
				float PaintEdgesSelection476 = step( 0.1 , ( ( 1.0 - PaintEdges471 ) * step( _DarkBrickAmount , PaintEdges471 ) ) );
				float2 uv_RGBA_Mask_A = packedInput.ase_texcoord7.zw * _RGBA_Mask_A_ST.xy + _RGBA_Mask_A_ST.zw;
				float4 tex2DNode371 = tex2D( _RGBA_Mask_A, uv_RGBA_Mask_A );
				float BricksDirtBlue598 = tex2DNode371.b;
				float BricksDirtRed597 = tex2DNode371.r;
				float HeightMask6 = saturate(pow(((BricksDirtBlue598*( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) ))*4)+(( _DamageAmount * ( packedInput.ase_color.g * BricksDirtRed597 ) )*2),_DamageSmoothness));
				...
				float BricksHeightBlue601 = tex2DNode606.a;
				float2 appendResult649 = (float2(( staticSwitch676 * 0.015625 ) , -0.25));
				float2 texCoord650 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + appendResult649;
				float4 TransitionUV3654 = tex2D( _MainTex, texCoord650 );
				float4 TransitionColor562 = ( BricksHeightBlue601 * TransitionUV3654 );
				float BricksStep406 = (0.0 + (step( 0.1 , ( ( 1.0 - HeightBricks385 ) * step( _TransitionScale , HeightBricks385 ) ) ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0));
				float4 lerpResult124 = lerp( BricksBrightDarkLerp581 , TransitionColor562 , BricksStep406);
				...
				float4 lerpResult548 = lerp( LerpTransition584 , UniqueBricksLerp547 , VertexAlpha521);
				float2 appendResult660 = (float2(temp_output_659_0 , -0.5));
				float2 texCoord661 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + appendResult660;
				float4 DirtColorUV3663 = tex2D( _MainTex, texCoord661 );
				float3 temp_cast_6 = (tex2DNode371.g).xxx;
				float VertexRed592 = packedInput.ase_color.r;
				float3 temp_cast_7 = (( 1.0 - VertexRed592 )).xxx;
				...
				float2 uv_TextureSample3 = packedInput.ase_texcoord7.zw * _TextureSample3_ST.xy + _TextureSample3_ST.zw;
				float3 unpack15 = UnpackNormalScale( tex2D( _TextureSample3, uv_TextureSample3 ), _BrickScale );
				unpack15.z = lerp( 1, unpack15.z, saturate(_BrickScale) );
				float2 uv_DBK_Brick_NM = packedInput.ase_texcoord7.zw * _DBK_Brick_NM_ST.xy + _DBK_Brick_NM_ST.zw;
				float3 unpack691 = UnpackNormalScale( tex2D( _DBK_Brick_NM, uv_DBK_Brick_NM ), _PaintedBrickScale );
				unpack691.z = lerp( 1, unpack691.z, saturate(_PaintedBrickScale) );
				float3 lerpResult689 = lerp( unpack15 , unpack691 , HeightBricks385);
				float2 uv_BrickUniqueNM = packedInput.ase_texcoord7.zw * _BrickUniqueNM_ST.xy + _BrickUniqueNM_ST.zw;
				float3 unpack517 = UnpackNormalScale( tex2D( _BrickUniqueNM, uv_BrickUniqueNM ), _BrickUniqueScale );
				unpack517.z = lerp( 1, unpack517.z, saturate(_BrickUniqueScale) );
				float3 lerpResult520 = lerp( lerpResult689 , unpack517 , VertexAlpha521);
				float3 Normals446 = lerpResult520;
...
/*ASEBEGIN
Version=18935
2560;133;1920;1133;-1592.151;2385.201;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;459;-4546.589,-2691.178;Inherit;False;Color Mask;-1;;40;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0.17;False;5;FLOAT;0.37;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;694;2280.978,-1956.984;Inherit;False;Property;_Color;Color;30;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;693;2470.978,-1718.984;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;677;1;447;0
WireConnection;677;7;639;0
ASEEND*/
//CHKSM=8007555053EB78F15A8BEFBBBFD04C882D1070C6